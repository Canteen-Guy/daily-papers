...
### 1. **[Hartree-Fock Limit for Energies in Solids](https://arxiv.org/abs/2606.20116v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-18
- **作者**: Jānis Užulis, Andris Gulans
- **标签**: `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 提出LAPW框架下HF极限计算方法
<details>
...
- **评分理由**: 方法创新且精度极高，为固态物理提供基准。

### 2. **[Effective masses, Burstein-Moss shift, and bandgap renormalization in degenerate Al-doped ZnO from broadband ellipsometry and Hall measurements](https://arxiv.org/abs/2606.20349v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-18
- **作者**: S. Mishra, L. A. Enrique, D. Cespedes et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出提取简并半导体能带参数的新方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且具有普适性，对透明导电氧化物研究有贡献

### 3. **[Exciton Transport in Disordered Perovskite Nanocrystal Solids](https://arxiv.org/abs/2606.20275v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-18
- **作者**: Simon Solari, Enrique Arévalo Rodríguez, Antonella Cutrupi et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示配体工程对钙钛矿纳米晶激子传输的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入探讨了能量无序对激子传输的决定性作用

### 4. **[Anomalous magneto-optical response at $\mathrm{RuO_2 / WSe_2}$ van der Waals interface](https://arxiv.org/abs/2606.20262v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-18
- **作者**: Muhammad Hassan Shaikh, Abhijith Puthiya Veettil, Collin Maurtua et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall` `physics.optics`
- **AI摘要**: 利用WSe2探测RuO2界面弱磁性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计巧妙，为争议性磁性材料研究提供新手段。

### 5. **[Polymer-polymer interdiffusion: effects of entanglements and a polymeric source](https://arxiv.org/abs/2606.20462v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-18
- **作者**: Avraham Moriel, Howard A. Stone
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci` `cond-mat.stat-mech`
- **AI摘要**: 研究聚合物扩散与源项影响的动力学机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用双流体模型分析扩散行为，理论严谨且具有应用潜力
