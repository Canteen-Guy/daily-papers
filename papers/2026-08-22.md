...
### 1. **[Effects of the surface on double surface Fermi arcs in a realistic tight-binding model of Na$_3$Bi (100)](https://arxiv.org/abs/2608.20115v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-08-20
- **作者**: Vasilios K. Passias, Lucas K. Wagner
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 研究Na3Bi表面对费米弧的影响
<details>
...
- **评分理由**: 通过紧束缚模型揭示了表面结构对拓扑费米弧的鲁棒性。

## Topological Photonics

### 1. **[Intensity-based scattering correction enables in vivo two-photon imaging beyond 1 mm](https://arxiv.org/abs/2608.20224v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-20
- **作者**: Yucheng Li, Renzhi He, Yi Xue
- **标签**: `physics.optics`
- **AI摘要**: DeepFOCUS提升双光子成像深度至1mm以上
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过深度学习实时调制光路，突破了成像深度限制。

### 2. **[Wide-field mid- to long-wave infrared imaging with undetected photons](https://arxiv.org/abs/2608.20015v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-20
- **作者**: Vladimir Kornienko, Nathan Gemmell, Caiyi Liu et al.
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 利用未探测光子实现中红外宽场成像
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 量子成像技术创新，突破红外探测背景限制

### 3. **[Point Spread Function Engineering Using Implicit Neural Representations](https://arxiv.org/abs/2608.20277v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Suet Ying Chan, Mitchell Gilmore, Qilin Deng et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出基于神经场的PSF工程设计方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用隐式神经表示优化相位分布，具有较好的通用性与鲁棒性。

### 4. **[Symmetry-guided modal control in elliptical femtosecond-laser-written photonic waveguides](https://arxiv.org/abs/2608.20124v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Tadas Paulauskas, Ubaid Ur Rehman, Eimantas Dermauskas et al.
...
- **评分理由**: 通过波导对称性设计有效抑制模态串扰，方法严谨且具有实用价值。

### 5. **[Geometric Control of Cat States in High Harmonic Generation](https://arxiv.org/abs/2608.20119v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Arti Gaharwar, Rocío Borrego-Varillas, Marcelo F. Ciappina et al.
- **标签**: `physics.optics` `quant-ph`
- **AI摘要**: 利用结构光调控高次谐波中的薛定谔猫态几何演化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，利用结构光实现量子态调控，逻辑严密。

## Metamaterials

### 1. **[Role of topology in scaling laws for studying mechanics in open-porous solids: Moving beyond classical Gibson-Ashby scaling](https://arxiv.org/abs/2608.20003v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-20
- **作者**: Ameya Rege
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci` `math-ph`
- **AI摘要**: 提出多孔材料拓扑结构力学标度律框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过拓扑描述符修正经典标度律，具有显著理论创新与实用价值。

### 2. **[Resonant state expansion for acoustic resonators. Part I. Eigenvalue problem](https://arxiv.org/abs/2608.19979v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-20
- **作者**: Egor Domoratskii, Vladimir Igoshin, Nikolay Solodovchenko et al.
- **标签**: `physics.comp-ph` `math-ph` `physics.optics`
- **AI摘要**: 提出声学谐振器的共振态展开法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 建立了声学共振态展开理论，方法严谨且应用广泛。

### 3. **[Resonant state expansion for acoustic resonators. Part II. Scattering problem](https://arxiv.org/abs/2608.19992v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Egor Domoratskii, Vladimir Igoshin, Nikolay Solodovchenko et al.
- **标签**: `physics.comp-ph` `math-ph` `physics.optics`
- **AI摘要**: 提出声学谐振器散射的共振态展开法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，方法通用，有效简化了复杂声学散射计算

## Spintronics

### 1. **[Amorphous and Nanocrystalline Topological Semimetal YPtBi/W/CoFeB Heterostructures for BEOL-Compatible Spin-Orbit Torque Devices](https://arxiv.org/abs/2608.20021v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-20
- **作者**: Quang Le, Brian R. York, Cherngye Hwang et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 开发BEOL兼容的拓扑自旋轨道矩器件
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验严谨，揭示了界面化学对自旋响应的调控机制

## Condensed Matter Physics

### 1. **[Mutually phase-stable tunable attosecond soft X-ray attosecond pulses from a free-electron laser](https://arxiv.org/abs/2608.20022v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-20
- **作者**: River Robles, David Cesar, Taran Driver et al.
- **标签**: `physics.acc-ph` `physics.optics`
- **AI摘要**: 实现相干可调阿秒软X射线脉冲对
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在自由电子激光器中实现高精度阿秒脉冲控制，技术突破显著。

### 2. **[Three-dimensional imaging of oxygen dopant distribution in Sr$_2$CuO$_{3+δ}$ by electron ptychography](https://arxiv.org/abs/2608.20199v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-20
- **作者**: Hongbin Yang, Jinkwon Kim, Desheng Ma et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用电子叠层成像技术揭示了铜氧化物中氧掺杂的应变依赖性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验方法先进，直观展示了氧掺杂与晶格应变的关系，具有重要物理意义。

### 3. **[Mid-infrared distributed-feedback lasing from black phosphorus under nanosecond excitation](https://arxiv.org/abs/2608.20096v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-20
- **作者**: Julien Brodeur, Laure Sène, Stéphane Kéna-Cohen
...
- **评分理由**: 展示了黑磷在硅基集成光子学中的应用潜力，实验严谨。

### 4. **[A Unified Theoretical Framework for Photoemission and Its Inverse: Reciprocity, Spin, and Photon Polarization](https://arxiv.org/abs/2608.20192v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Frank O. Schumann, Jürgen Henk
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出光电子发射与逆过程的统一理论框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过响应张量统一描述SARPES与SARIPES，理论严谨且具普适性。

### 5. **[Quantum Dissipative Paraelectricity](https://arxiv.org/abs/2608.20168v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: A. Cano
...
- **评分理由**: 通过准精确可解模型揭示了对称性破缺的耗散抑制机制

## Theoretical Physics

### 1. **[Computational Methods of Wave Propagation for Semiclassical Models of High Harmonic Generation in Bulk Solids](https://arxiv.org/abs/2608.20306v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: Ava N. Hejazi, Nicholas Karpowicz, Gregory D. Scholes et al.
- **标签**: `physics.optics` `physics.chem-ph`
- **AI摘要**: 提出非线性光物质相互作用自洽计算框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该模型有效结合麦克斯韦与布洛赫方程，对强场物理具有重要理论意义。
...
- **评分**: ⭐ 78/100 | **日期**: 2026-08-20
- **作者**: A. L. Elliott, H. Markland, K. G. Miller et al.
- **标签**: `physics.optics` `physics.plasm-ph`
- **AI摘要**: 利用双色飞焦脉冲实现太赫兹波前整形
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过动态控制电离前沿速度实现波前调控，方法创新且具有应用价值。

### 3. **[Floquet Theory for Light-Driven Rotation of Dipolar and Multipolar Particles](https://arxiv.org/abs/2608.20197v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-20
- **作者**: Amane Takano, Minoru Kanega, Masahiro Sato
- **标签**: `cond-mat.mes-hall` `cond-mat.stat-mech` `physics.class-ph`
- **AI摘要**: 利用Floquet理论解析光驱动微粒旋转机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Floquet理论构建非平衡相图，理论严谨且具有应用价值。
