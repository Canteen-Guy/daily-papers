...
### 1. **[Symmetry-Selective Topological Magnon Engineering by Phonon Angular Momentum](https://arxiv.org/abs/2605.28425v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-27
- **作者**: Markus Weißenhofer, Philipp Rieger, Chandan K. Singh et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 利用声子角动量实现磁子拓扑相的对称性选择调控
<details>
...
- **评分理由**: 结合Floquet理论与第一性原理，创新性地提出声子调控磁子拓扑的新机制。

### 2. **[Electrically driven Rabi dynamics of magnetic-field-induced corner states in a two-dimensional topological insulator](https://arxiv.org/abs/2605.28499v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-27
- **作者**: D. V. Khomitsky, E. A. Lavrukhina, D. P. Krasavin et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 实现拓扑绝缘体边缘态的电驱动Rabi振荡
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论模型严谨，为拓扑量子计算提供新路径

## Topological Photonics

### 1. **[Isotropic fabrication of centimeter-scale, low propagation-loss periodically poled lithium niobate nanophotonic waveguides for efficient second harmonic generation](https://arxiv.org/abs/2605.28689v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-27
- **作者**: Guanghui Zhao, Yixuan Yang, Renhong Gao et al.
- **标签**: `physics.optics`
- **AI摘要**: 实现超低损耗PPLN纳米波导及高效倍频
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破性制备工艺，大幅提升非线性转换效率与性能

### 2. **[Orbital Altermagnetic Photonic Crystal](https://arxiv.org/abs/2605.28656v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-27
- **作者**: Sichang Qiu, Huichang Li, Yan Meng et al.
...
- **评分理由**: 创新性引入反铁磁概念至光子学，实验验证充分。

### 3. **[Toward Micro-Endoscopy: Distal-Free, Configuration-Agnostic Focusing Through Multimode Fiber](https://arxiv.org/abs/2605.28506v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-27
- **作者**: Dvir Marsh, Lior Fridman, Stav Lotan et al.
- **标签**: `physics.optics`
- **AI摘要**: 基于深度学习的多模光纤反射式聚焦成像方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用反射信号实现多模光纤聚焦，创新性与实用性强。

### 4. **[Substrate-driven topological engineering in plasmonic Su-Schrieffer-Heeger chains](https://arxiv.org/abs/2605.28463v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-27
- **作者**: Florian Herz, Alireza Naeimi, Svend-Age Biehs
- **标签**: `cond-mat.mes-hall` `physics.optics`
- **AI摘要**: 利用基底调控等离激元SSH链拓扑态
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过基底相互作用实现拓扑相变，机制创新且分析严谨。

### 5. **[A variability-aware simulation and design workflow for wafer-scale, heterogeneously integrated lithium niobate modulators](https://arxiv.org/abs/2605.28765v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-27
- **作者**: Patrick Nenezic, Ewoud Vissers, Arno Moerman et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出铌酸锂调制器变异感知仿真流程
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合制造数据优化设计，提升了晶圆级集成可靠性。

## Metamaterials

### 1. **[Simultaneous Measurement of Circular Dichroism and Circular Differential Scattering](https://arxiv.org/abs/2605.28458v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-27
- **作者**: Qiang Hao, Pathum Wathudura, Huy Pham et al.
- **标签**: `physics.optics`
- **AI摘要**: 研发双通道光谱仪实现CD与CDS同步测量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出创新测量方法，实验验证严谨，具有较高实用价值。

## Condensed Matter Physics

### 1. **[How reproducible are first-principles simulations of liquid water?](https://arxiv.org/abs/2605.28798v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-27
- **作者**: Niamh ONeill, Benjamin X. Shi, William J. Baldwin et al.
- **标签**: `physics.chem-ph` `cond-mat.mtrl-sci` `physics.comp-ph`
- **AI摘要**: 揭示并解决了液态水模拟的重现性差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过机器学习势函数解决了DFT模拟的重现性问题

### 2. **[Realization of the Ruby Lattice Antiferromagnet in Layered Transition-Metal Fluorides](https://arxiv.org/abs/2605.28821v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-27
...
- **评分理由**: 通过DFT与蒙特卡洛模拟证实了新型磁性材料，方法严谨。

### 3. **[Avoided Stoner instability at a single ordinary Van Hove point](https://arxiv.org/abs/2605.28761v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-27
- **作者**: I. S. Tupitsyn, B. Currie, A. V. Chubukov et al.
- **标签**: `cond-mat.str-el` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示二维Hubbard模型中Stoner不稳定性被抑制的机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用精确蒙特卡洛方法解决了长期存在的理论分歧

### 4. **[Universal Stability of Ga Split Vacancies across α-, β-, and κ-Ga2O3 Polymorphs: A Machine-Learning Accelerated Study](https://arxiv.org/abs/2605.28743v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-27
- **作者**: Mohamed Abdelilah Fadla, Myrta Grüning, Lorenzo Stella
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示Ga2O3多晶型中分裂空位的普遍稳定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与DFT，系统性揭示了缺陷物理机制

### 5. **[Ultrafast dynamics of excitons in black phosphorus](https://arxiv.org/abs/2605.28611v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-27
- **作者**: Geoffroy Kremer, Juan F. P. Mosquera, Joël Morf et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示黑磷激子超快动力学与声子散射机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实验与理论，对激子退相干机制研究深入。

## Theoretical Physics

### 1. **[Unified Analytical Framework for SPAD Array Receivers with Dead-Time-Induced Blocking Loss and Inter-Symbol Interference in PAM-OWC Systems](https://arxiv.org/abs/2605.28560v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-27
- **作者**: Chen Wang, Zhiyong Xu, Jingyuan Wang et al.
- **标签**: `eess.SP` `physics.optics`
- **AI摘要**: 提出SPAD阵列接收机死区效应与ISI统一分析框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型构建严谨，对光无线通信系统设计具有重要理论指导价值。
