...
### 1. **[Skyrmion nucleus resolves the Landauer paradox](https://arxiv.org/abs/2609.11551v1)**
- **评分**: ⭐ 92/100 | **日期**: 2026-09-10
...
- **评分理由**: 通过拓扑机制解决铁电切换的核心物理难题，理论与实验高度吻合。

### 2. **[Temporal Localisation of Waves from Imaginary Line-Gap Topology](https://arxiv.org/abs/2609.11577v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Carlos Camacho, Tom Sheppard, Joshua Feis et al.
- **标签**: `physics.optics`
- **AI摘要**: 揭示非厄米对称性与时间波局域化的拓扑关联。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性地分类了非厄米系统的时间局域化机制，理论严谨。

## Topological Photonics

### 1. **[Heterogeneously Integrated Efficient and Widely Tunable Lasers at 795 nm for Rubidium-Based Quantum Technologies](https://arxiv.org/abs/2609.11585v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Max Kiewiet, Stijn Cuyvers, Tom Reep et al.
- **标签**: `physics.optics` `quant-ph`
- **AI摘要**: 微转移打印实现高性能集成激光器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 技术创新显著，在量子技术应用中具有高实用价值。

## Metamaterials

### 1. **[Antimony for broadband nanophotonics across the ultraviolet, visible and infrared](https://arxiv.org/abs/2609.11501v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Fernando Chacón-Sánchez, Jacek Wojcik, Marina García Pardo et al.
- **标签**: `physics.optics` `cond-mat.mtrl-sci`
- **AI摘要**: 首次测定锑纳米薄膜全光谱介电函数并展示其光子学应用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验数据详实且覆盖范围广，对纳米光子学设计具有重要价值。

### 2. **[Designing metallo-dielectric antennas for cryogenic applications](https://arxiv.org/abs/2609.11809v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-10
- **作者**: Siwei Luo, Tim Hebenstreit, Alexey Shkarin et al.
- **标签**: `physics.optics`
- **AI摘要**: 设计了用于低温环境的高效金属介质天线
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 设计新颖且实验验证充分，在量子光学应用中具有较高实用价值。

## Spintronics

### 1. **[Piezomagnetism in a model cubic noncollinear altermagnet](https://arxiv.org/abs/2609.11816v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Sudarshan Sharma, Luca Buiarelli, Richard Spieker et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall` `cond-mat.str-el`
- **AI摘要**: 揭示MnTe2压磁效应并验证其作为模型反铁磁体
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实验与理论，系统验证了非共线反铁磁体的压磁响应。

## Condensed Matter Physics

### 1. **[High-Temperature ferromagnetism from site-selective filling in (Fe,Ni)$_{6-δ}$GeTe$_2$](https://arxiv.org/abs/2609.11862v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-10
- **作者**: Tyler L. Werner, Jonathan T. Reichanadter, Xiang Chen et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.str-el`
- **AI摘要**: 揭示Fe6GeTe2纳米析出相提升居里温度的微观机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合ARPES与第一性原理，深入解析了高居里温度的物理起源。

### 2. **[Effective Ionic Valence and Local Magnetic Moment in Kagome Superconductors](https://arxiv.org/abs/2609.11927v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Ruoshi Jiang, Zi-Jian Lang, Yuzki Oey et al.
- **标签**: `cond-mat.str-el` `cond-mat.mtrl-sci` `cond-mat.supr-con`
- **AI摘要**: 揭示了笼目超导体中局域磁矩的强关联物理机制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实验证实了局域磁矩的存在，挑战了传统巡游电子图像，具有较高创新性。

### 3. **[Low temperature thermodynamics of $S_{\mathrm{eff}}=1/2$ triangular lattice quantum spin liquid candidate TlYbS$_2$](https://arxiv.org/abs/2609.11881v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Bishnu P. Belbase, Arjun Unnikrishnan, Piyush Chhallare et al.
- **标签**: `cond-mat.str-el` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示TlYbS2量子自旋液体候选材料的低温热力学特性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验表征详尽，对理解三角晶格量子磁性有重要贡献

### 4. **[High-fidelity k$\cdot$p representations of first-principles electronic band structures through covariant renormalization](https://arxiv.org/abs/2609.11861v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Kristian Berland
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall` `physics.comp-ph`
- **AI摘要**: 提出协变重整化k·p模型以提升能带计算精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该方法有效解决了传统k·p模型收敛慢与非局域性问题

### 5. **[Sub-cycle doublon-holon dynamics in one-dimensional Mott insulators revealed by two-color high-harmonic spectroscopy](https://arxiv.org/abs/2609.11858v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-10
- **作者**: Lance Hatch, Aditya Verma, Eric Schultz et al.
- **标签**: `cond-mat.str-el` `physics.optics`
- **AI摘要**: 揭示了一维莫特绝缘体中亚光学周期的双子-空穴动力学。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用高次谐波光谱探测强关联体系，方法创新且实验严谨。
