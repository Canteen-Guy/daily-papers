...
### 1. **[Optomechanical systems with a Fano membrane in the middle](https://arxiv.org/abs/2607.22526v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-24
- **作者**: Lei Du, Aymeric Frerejean, Witlef Wieczorek et al.
- **标签**: `physics.optics` `quant-ph`
- **AI摘要**: 利用Fano膜实现光力系统光谱调控
<details>
...
- **评分理由**: 提出新颖的Fano膜光力耦合机制，理论严谨且具有实际应用潜力。

## Condensed Matter Physics

### 1. **[Quasiparticle interference as a tool to study quantum materials](https://arxiv.org/abs/2607.22487v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-24
- **作者**: Luke C. Rhodes, Yuhki Kohsaka, Tetsuo Hanaguri et al.
- **标签**: `cond-mat.str-el` `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 综述准粒子干涉技术在量子材料研究中的应用与进展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统梳理了QPI技术原理与应用，学术价值高且逻辑清晰。

### 2. **[Reversible photo-switching optical functionality in two-dimensional mixed-halide hybrid perovskites](https://arxiv.org/abs/2607.22476v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-24
- **作者**: Enamul Haque, Wenxin Mao, Javier Cerrillo
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示二维钙钛矿光致卤素离子交换机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论深度高，机制创新，对光电材料研究有重要意义

### 3. **[Multiplexed storage and interaction of Rydberg spinwaves via the gradient echo memory protocol](https://arxiv.org/abs/2607.22466v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-24
- **作者**: Bartosz Niewelt, Stanisław Kurzyna, Bartosz Kasza et al.
- **标签**: `quant-ph` `physics.atom-ph` `physics.optics`
- **AI摘要**: 实现里德堡自旋波多路存储与交互
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过新颖的N型方案解决了退相干问题，提升了量子存储性能。

### 4. **[Charge-Density-Wave Phase Transitions in Monolayer 1T-TaS2 from Universal Machine Learning Molecular Dynamics](https://arxiv.org/abs/2607.22316v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-24
- **作者**: Valentina Nesterova, Tribhuwan Pandey, Tom Berlijn et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用通用机器学习势模拟TaS2电荷密度波相变
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与MD模拟，高效揭示了CDW相变机制，方法严谨且具有普适性。

### 5. **[SAGE-Net: Semantics-Augmented Geometric Encoder for Material Property Prediction](https://arxiv.org/abs/2607.22271v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-24
- **作者**: Guanghui Zhang, Yuxuan Yao, Kieran B. Spooner et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出SAGE-Net实现材料属性预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入语义引导消息传递，显著提升多模态预测精度

## Theoretical Physics

### 1. **[Fluctuational Quantum Electrodynamics of Dispersive Time-Varying Media](https://arxiv.org/abs/2607.22340v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-24
- **作者**: Jaime E. Sustaeta-Osuna, Thomas F. Allard, Francisco J. García-Vidal et al.
- **标签**: `physics.optics` `quant-ph`
- **AI摘要**: 提出时变介质量子电动力学框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 建立了时变耗散介质的量子化理论，具有高度原创性与严谨性。

### 2. **[Metrology of quantum imaging schemes](https://arxiv.org/abs/2607.22373v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-24
- **作者**: Emma Brambila, Giacomo Sorelli
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 利用量子费舍尔信息评估量子成像方案
<details>
<summary>原始摘要</summary>
