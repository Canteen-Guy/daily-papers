...
### 1. **[Disentangling topological and anomalous Hall contributions of skyrmions using Kerr microscopy and thermal transport measurements](https://arxiv.org/abs/2607.15946v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-17
- **作者**: H. Heyen, M. Vogel, F. Gossing et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.other`
- **AI摘要**: 利用克尔显微镜解耦斯格明子霍尔效应
<details>
...
- **评分理由**: 通过多模态测量有效分离了拓扑与反常霍尔贡献

## Topological Physics

### 1. **[Vortex formation around islands in random waves](https://arxiv.org/abs/2607.15938v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Alex J. Vernon, Junyi Ye, Wenzhe Liu et al.
- **标签**: `physics.flu-dyn` `physics.ao-ph` `physics.class-ph`
- **AI摘要**: 揭示随机波场中岛屿涡旋形成机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论与实验结合紧密，解释了潮汐涡旋现象。

## Topological Photonics

### 1. **[Quantum scanning synthetic optical holography](https://arxiv.org/abs/2607.16176v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Josué R. León-Torres, Byron Caiza, Nadia Baumann et al.
- **标签**: `physics.optics`
- **AI摘要**: 实现量子成像中未探测光合成全息术
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将合成全息引入量子成像，实现了中红外相位成像。

### 2. **[Conjugate phase-noise cancellation enables submicrometre dual-comb ranging with free-running megahertz-linewidth lasers](https://arxiv.org/abs/2607.15843v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Yue You, Zaifan Wu, Yi Zou et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出共轭相位噪声抵消法实现低成本高精度测距
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决自由运行激光器相位噪声问题，实验严谨

### 3. **[Electromagnetically induced transparency lasing in distributed resonant feedback system](https://arxiv.org/abs/2607.15783v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Yaoyao Liang, Xinyue Wang, Hongyi Tian et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用损耗实现EIT激光发射
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出损耗诱导EIT机制，实现低阈值激光，创新性强。

## Metamaterials

### 1. **[Optical Control of Chirality by Ultrafast Symmetry Breaking in Membrane Metasurfaces](https://arxiv.org/abs/2607.16067v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Nikita Glebov, Alena Mamonova, Olesia Pashina et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用超快对称性破缺实现手性动态调控
<details>
<summary>原始摘要</summary>

Chirality Chirality underpins a wide range of light-matter interactions, yet methods for its dynamic control in photonic systems remain limited. Here, we demonstrate ultrafast all-optical control of chirality in silicon metasurfaces through transient symmetry breaking. Our approach exploits photonic eigenstates of opposite spatial parity engineered to be highly susceptible to symmetry perturbations. Optical excitation generates free carriers that establish a transient refractive-index gradient across the membrane thickness, breaking out-of-plane mirror symmetry and facilitating hybridization of the parity-opposite modes into chiral photonic states. This enables the reversible creation and modulation of chirality on a 10-100 ps timescale, manifested by pronounced changes in the metasurface circular dichroism. By dynamically reconfiguring a fundamental symmetry property of the photonic structure rather than merely its optical response, our work establishes a route towards ultrafast control of chiral light-matter interactions and opens opportunities for active nanophotonic and information processing technologies.
</details>
- **评分理由**: 创新性强，通过光激发打破对称性实现手性调制

### 2. **[Reconfigurable Nonlocal Light-Emitting Metalens Nanolasers via Bound States in the Continuum](https://arxiv.org/abs/2607.15852v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Omar A. M. Abdelraouf
- **标签**: `physics.optics` `physics.app-ph` `physics.comp-ph`
- **AI摘要**: 基于BIC超表面的全光可调谐纳米激光器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合PCM与BIC实现动态波前与波长调控，实验扎实。

## Spintronics

### 1. **[Reversible and irreversible dynamical topological transitions of magnetic Hopfions](https://arxiv.org/abs/2607.15777v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: S. Y. Lu, H. M. Dong, D. X. Yu et al.
- **标签**: `cond-mat.other`
- **AI摘要**: 揭示磁霍普夫子在交变磁场下的动力学拓扑相变机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合微磁模拟与解析分析，系统阐明了霍普夫子动力学行为

### 2. **[Electrothermal control of spin-reorientation transition in Co/Fe_3GaTe_2 heterostructures](https://arxiv.org/abs/2607.15844v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-17
- **作者**: Po-Wei Chen, Ming-Hsien Hsu, Cheng-Ying Hsiao et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 实现Co/FGaT异质结电热磁各向异性调控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过电热效应实现范德华磁体自旋重取向，方法严谨且具应用潜力。

## Condensed Matter Physics

### 1. **[Sub-microsecond conformational dynamics in an optical nanocavity](https://arxiv.org/abs/2607.15925v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-17
- **作者**: Heehun Sung, Sam C Scholten, Pavlina Sasheva et al.
- **标签**: `physics.optics` `cond-mat.mes-hall` `physics.app-ph`
- **AI摘要**: 利用纳米腔实现蛋白质亚微秒动力学观测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 技术突破显著，实验严谨，对生物物理研究贡献大

### 2. **[Triple-Resonance Spectroscopy Using a Cavity-Enhanced Frequency Comb Probe](https://arxiv.org/abs/2607.15793v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-17
- **作者**: Qinxue Nie, Vinicius Silva de Oliveira, Adrian Hjältén et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出三共振光谱法探测高激发分子态
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 技术创新显著，实验精度极高，对分子物理贡献大

### 3. **[A Dynamical Phase-Field Model for the Optical Properties of Ferroelectrics](https://arxiv.org/abs/2607.16180v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Aiden Ross, Anya Frazer, Venkatraman Gopalan et al.
...
- **评分理由**: 模型创新性强且实用，理论严谨，逻辑清晰。

### 4. **[Structural Relaxation Enables Millisecond Infrared Photodetection in Selenium Iodine Semiconductors](https://arxiv.org/abs/2607.16054v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-17
- **作者**: Biman Jana
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用结构弛豫提升SeI2红外探测性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构演化优化载流子输运，实验设计严谨且实用性强。

### 5. **[Atomistic mechanism of corrosion-induced grain boundary migration in NiCr alloys in molten FLiNaK](https://arxiv.org/abs/2607.16167v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-17
- **作者**: Sadia Khan, Hamdy Arkoub, Miaomiao Jin
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示镍铬合金熔盐腐蚀的晶界迁移机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计巧妙且严谨，显著提升了辐射源亮度。

### 2. **[Role of Spatial Coherence in Single-Shot Lensless Image Reconstruction](https://arxiv.org/abs/2607.15765v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-17
- **作者**: Ganesh M. Balasubramaniam, Xiao-Liu Chu, Matthew R. Foreman
- **标签**: `physics.optics`
- **AI摘要**: 引入相干感知模型优化无透镜成像
<details>
<summary>原始摘要</summary>
