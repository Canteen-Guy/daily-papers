...
### 1. **[LLMs Improving LLMs: Agentic Discovery for Test-Time Scaling](https://arxiv.org/abs/2605.08083v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Tong Zheng, Haolin Liu, Chengsong Huang et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出AutoTTS框架自动发现推理策略
<details>
...
- **评分理由**: 通过环境驱动自动优化推理计算分配，方法创新且实验扎实。

### 2. **[Rubric-Grounded RL: Structured Judge Rewards for Generalizable Reasoning](https://arxiv.org/abs/2605.08061v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Manish Bhattarai, Ismael Boureima, Nishath Rajiv Ranasinghe et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出基于评分标准的强化学习框架以提升推理能力
<details>
<summary>原始摘要</summary>
...
- **评分**: ⭐ 76/100 | **日期**: 2026-05-08
- **作者**: James Petullo, Sonny George, Dylan Cashman et al.
- **标签**: `cs.AI`
- **AI摘要**: 提出VecCISC框架，通过聚类优化LLM推理成本。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法有效降低推理开销，实验充分，具有实用价值。

## Natural Language Processing

### 1. **[Accurate and Efficient Statistical Testing for Word Semantic Breadth](https://arxiv.org/abs/2605.08048v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Yo Ehara
- **标签**: `cs.CL`
- **AI摘要**: 提出Householder对齐置换检验以准确评估词义广度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，有效解决了语义方向干扰导致的统计偏差。

### 2. **[Uncertainty-Aware Structured Data Extraction from Full CMR Reports via Distilled LLMs](https://arxiv.org/abs/2605.08045v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Yi Yu, Parker Martin, Zhenyu Bu et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出CMR报告结构化提取与不确定性评估框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，实验严谨，有效提升临床数据质量。

### 3. **[CA-SQL: Complexity-Aware Inference Time Reasoning for Text-to-SQL via Exploration and Compute Budget Allocation](https://arxiv.org/abs/2605.08057v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-08
- **作者**: James Petullo, Nianwen Xue
- **标签**: `cs.CL` `cs.AI`
- **AI摘要**: 提出CA-SQL框架，通过动态探索提升复杂Text-to-SQL性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且在BIRD基准上表现优异，实验设计严谨。

## Vision Language Models

### 1. **[Proxy3D: Efficient 3D Representations for Vision-Language Models via Semantic Clustering and Alignment](https://arxiv.org/abs/2605.08064v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Jerry Jiang, Haowen Sun, Denis Gudovskiy et al.
- **标签**: `cs.CV`
- **AI摘要**: 提出Proxy3D以紧凑代理表示提升VLM空间推理能力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实验扎实，有效提升了3D视觉问答性能

## Diffusion Models

### 1. **[Normalizing Trajectory Models](https://arxiv.org/abs/2605.08078v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Jiatao Gu, Tianrong Chen, Ying Shen et al.
- **标签**: `cs.CV` `cs.LG`
- **AI摘要**: 提出NTM模型实现高效精确似然生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合归一化流与扩散模型，兼顾采样效率与似然估计

### 2. **[Flow-OPD: On-Policy Distillation for Flow Matching Models](https://arxiv.org/abs/2605.08063v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Zhen Fang, Wenxuan Huang, Yu Zeng et al.
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出Flow-OPD框架优化流匹配模型对齐
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入策略蒸馏解决多任务对齐冲突，实验效果显著。

## Multimodal

### 1. **[123D: Unifying Multi-Modal Autonomous Driving Data at Scale](https://arxiv.org/abs/2605.08084v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Daniel Dauner, Valentin Charraut, Bastian Berle et al.
- **标签**: `cs.RO` `cs.CV`
- **AI摘要**: 提出统一多模态自动驾驶数据框架123D
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了多源数据碎片化问题，实用性强且实验严谨

## Video Generation

### 1. **[MoCoTalk: Multi-Conditional Diffusion with Adaptive Router for Controllable Talking Head Generation](https://arxiv.org/abs/2605.08050v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Xinyan Ye, Jiankang Deng, Abbas Edalat
- **标签**: `cs.CV`
- **AI摘要**: 提出自适应路由的多条件扩散模型以生成可控人脸视频
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过自适应路由解决多模态冲突，技术创新且实验扎实。

## Agent

### 1. **[The Memory Curse: How Expanded Recall Erodes Cooperative Intent in LLM Agents](https://arxiv.org/abs/2605.08060v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-08
- **作者**: Jiayuan Liu, Tianqin Li, Shiyi Du et al.
- **标签**: `cs.CL` `cs.AI` `cs.GT`
- **AI摘要**: 揭示长记忆导致LLM智能体协作意图下降的机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入且实验严谨，对智能体协作有重要启发。

## Information Retrieval

### 1. **[Conformal Path Reasoning: Trustworthy Knowledge Graph Question Answering via Path-Level Calibration](https://arxiv.org/abs/2605.08077v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Shuhang Lin, Chuhao Zhou, Xiao Lin et al.
- **标签**: `cs.CL`
- **AI摘要**: 提出CPR框架实现知识图谱问答的置信度校准
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过路径级校准显著提升了KGQA的可靠性与效率

## Computer Vision

### 1. **[EmambaIR: Efficient Visual State Space Model for Event-guided Image Reconstruction](https://arxiv.org/abs/2605.08073v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Wei Yu, Yunhang Qian
- **标签**: `cs.CV` `cs.AI`
- **AI摘要**: 提出EmambaIR，利用SSM实现高效事件图像重建。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入SSM解决计算复杂度问题，实验全面且性能优越。

### 2. **[Towards Highly-Constrained Human Motion Generation with Retrieval-Guided Diffusion Noise Optimization](https://arxiv.org/abs/2605.08054v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Hanchao Liu, Fang-Lue Zhang, Shining Zhang et al.
- **标签**: `cs.CV`
- **AI摘要**: 基于检索引导的扩散模型动作生成方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过检索增强扩散噪声优化，有效解决高约束动作生成难题。

### 3. **[6D Pose Estimation via Keypoint Heatmap Regression with RGB-D Residual Neural Networks](https://arxiv.org/abs/2605.08059v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-05-08
- **作者**: Ismail Aljosevic, Amir Masoud Almasi, Ana Parovic et al.
- **标签**: `cs.CV` `cs.RO`
- **AI摘要**: 基于RGB-D热图回归的6D姿态估计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且实验充分，但在创新性上属于增量改进。

## Machine Learning

### 1. **[Reinforcement Learning for Exponential Utility: Algorithms and Convergence in Discounted MDPs](https://arxiv.org/abs/2605.08053v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-08
- **作者**: Gugan Thoppe, L. A. Prashanth, Ankur Naskar et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出指数效用MDP的强化学习算法及收敛性证明
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论贡献扎实，解决了指数效用RL的算法基础问题

### 2. **[Zero-Shot Imagined Speech Decoding via Imagined-to-Listened MEG Mapping](https://arxiv.org/abs/2605.08075v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Maryam Maghsoudi, Shihab Shamma
- **标签**: `cs.LG` `eess.AS`
- **AI摘要**: 提出基于听觉映射的零样本想象语音解码方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过跨模态映射解决想象语音数据稀缺问题，方法创新且实验严谨。

### 3. **[GRAPHLCP: Structure-Aware Localized Conformal Prediction on Graphs](https://arxiv.org/abs/2605.08074v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-08
- **作者**: Peyman Baghershahi, Fangxin Wang, Debmalya Mandal et al.
- **标签**: `cs.LG`
- **AI摘要**: 提出图结构感知的局部一致性预测框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合图拓扑与PPR优化不确定性量化，方法严谨且有效。

### 4. **[A Note on Non-Negative $L_1$-Approximating Polynomials](https://arxiv.org/abs/2605.08072v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-08
- **作者**: Jane H. Lee, Anay Mehrotra, Manolis Zampetakis
- **标签**: `stat.ML` `cs.DS` `cs.LG`
- **AI摘要**: 证明了高斯分布下非负L1逼近多项式的存在性
<details>
<summary>原始摘要</summary>
