...
### 1. **[High-speed electrically driven liquid-crystal compact optical skyrmion encoder](https://arxiv.org/abs/2606.19165v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Yu-Ping Tang, Zhenyu Guo, Ze-Yu Wang et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出高速电控液晶光学斯格明子发生器
<details>
...
- **评分理由**: 实现了亚毫秒级高速切换，在拓扑光子学应用中具有显著创新性。

## Topological Photonics

### 1. **[Spontaneous parametric down-conversion pumped by spatiotemporal structured light](https://arxiv.org/abs/2606.19219v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Lukas Montenegro, Rafael F. Barros
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 利用时空结构光调控自发参量下转换光谱相关性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出了一种通过泵浦光空间结构控制量子态的新颖方法，理论严谨且具有应用潜力。

### 2. **[Thermodynamics of photonic nonlinear Aharonov-Bohm cages](https://arxiv.org/abs/2606.18896v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Stefano Iubini, Carlo Danieli
- **标签**: `cond-mat.stat-mech` `physics.optics`
- **AI摘要**: 非线性光子晶格的热电输运调控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合非线性与AB笼效应优化热电性能，理论严谨且创新。

## Metamaterials

### 1. **[Extreme mid-infrared field enhancement and anapoles in high-index plasmonic metamaterials](https://arxiv.org/abs/2606.19114v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Zoltan Sztranyovszky, Nicolas Spiesshofer, Caleb Todd et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出高折射率等离激元超材料以增强光与物质相互作用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实验严谨，在红外光子学领域具应用潜力。

### 2. **[EDoF-NeRF: extended depth-of-field neural radiance fields using a coded aperture camera](https://arxiv.org/abs/2606.18826v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Yoshiyuki Shirasaki, Ryoichi Horisaki
- **标签**: `physics.optics` `cs.CV` `eess.IV`
- **AI摘要**: 利用编码孔径扩展NeRF景深
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合光学编码与NeRF，实验验证充分。

## Spintronics

### 1. **[Controllable Growth and Characterization of α- and β-phase MnSe by Chemical Vapor Deposition](https://arxiv.org/abs/2606.19142v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-17
- **作者**: Jennifer E. DeMell, Elias Kallon, Michael Pedowitz et al.
- **标签**: `cond-mat.mtrl-sci` `physics.app-ph`
- **AI摘要**: 实现MnSe相可控生长及磁性表征
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，为二维磁性材料提供新平台

## Condensed Matter Physics

### 1. **[Thermodynamic-Kinetic Decoupling Enables Stable Excitonic Emission in Defect-Tolerant Cu-Based Quantum Dots](https://arxiv.org/abs/2606.18939v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-17
- **作者**: Haoran Chen, Zhipeng Xu, Chunjian Li et al.
- **标签**: `physics.optics` `cond-mat.mes-hall`
- **AI摘要**: 提出热力学-动力学解耦策略实现高效量子点发射
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决缺陷迁移问题，实验严谨且应用前景广阔。

### 2. **[Spin point group symmetry and classification of non-relativistic spin splitting in non-collinear magnetic structures: Identification of high-order spin splitting types (l=5,7, and 9)](https://arxiv.org/abs/2606.19254v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Luis Elcoro, Jesus Etxebarria, J. Manuel Perez-Mato et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 建立自旋点群理论并发现高阶自旋劈裂
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统性分类磁结构对称性，理论严谨且具应用价值

### 3. **[Direct large-area observation of subsurface plastic activity in conditioned copper electrodes](https://arxiv.org/abs/2606.19192v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Yinon Ashkenazy, Inna Popov, Victoria M. Bjelland et al.
- **标签**: `cond-mat.mtrl-sci` `physics.acc-ph`
- **AI摘要**: 观测到铜电极高场调节下的位错演化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 首次大尺度观测到高场调节的位错机制，实验严谨。

### 4. **[AdsMind: A Physics-Grounded Multi-Agent System for Self-Correcting Discovery of Adsorption Configurations on Heterogeneous Catalyst Surfaces](https://arxiv.org/abs/2606.19152v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Zongmin Zhang, Yuyang Lou, Bowen Zhang et al.
- **标签**: `cond-mat.mtrl-sci` `cs.AI`
- **AI摘要**: 提出AdsMind框架实现催化吸附构型自修正发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过闭环反馈机制显著提升了催化构型搜索的效率与准确性

### 5. **[Room-Temperature Calcium Intercalation into Graphite Catalyzed by Sodium](https://arxiv.org/abs/2606.19024v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-17
- **作者**: Akira Iyo, Shigeyuki Ishida, Hiroshi Eisaki et al.
