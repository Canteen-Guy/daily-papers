...
### 1. **[Temporal glide symmetry enforces a parity sideband selection rule in scalar bulk media](https://arxiv.org/abs/2606.13609v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-11
- **作者**: Miguel Camacho
- **标签**: `physics.optics` `cond-mat.mes-hall` `physics.app-ph`
- **AI摘要**: 揭示时间滑移对称性的频率转换选择定则
<details>
...
- **评分理由**: 理论创新性强且验证严谨，对光子学有重要意义。

### 2. **[Real-Time Visualization of the Spatiotemporal Dynamics of 3D Solitons](https://arxiv.org/abs/2606.13456v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-11
- **作者**: XinGe Liu, Chaoyang Geng, Yunhan Yu et al.
- **标签**: `physics.optics` `nlin.PS`
- **AI摘要**: 实现三维光孤子时空动力学实时观测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性提出多路复用技术，实验严谨且具有高应用价值。

### 3. **[Optical Implementation of Equilibrium Propagation Using Spatial Photonic Ising Machines](https://arxiv.org/abs/2606.13454v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-11
- **作者**: Dimitri Vanden Abeele, Daniele Veraldi, Davide Pierangeli et al.
- **标签**: `physics.optics` `cond-mat.dis-nn` `cs.ET`
- **AI摘要**: 提出基于SPIM的光学平衡传播训练方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合光学硬件与机器学习，实验验证有效

### 4. **[Ultrafast chiral sensing with an ultraviolet vector beam](https://arxiv.org/abs/2606.13402v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-11
- **作者**: Aude Rodriguez, Laura Rego
- **标签**: `physics.optics` `physics.app-ph`
- **AI摘要**: 利用紫外矢量光束实现超快手性分子识别
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合矢量光束与高次谐波，创新性强且方法严谨。

### 5. **[Polarization-controlled transport of light in a two-dimensional waveguide](https://arxiv.org/abs/2606.13437v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-11
- **作者**: J. V. S. Ferreira, A. M. G de Melo, N. A. Moreira et al.
- **标签**: `physics.optics`
- **AI摘要**: 揭示二维波导中偏振控制的光传输机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究深入探讨了二维系统中的光传输特性，理论扎实且具有应用潜力。

## Metamaterials

### 1. **[Programmable Synthetic Motion at a Time-Varying Interface](https://arxiv.org/abs/2606.13557v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-11
- **作者**: A. C Harwood, D. Cielecki, T. V. Raziman et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出可编程时空超材料调制方案
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计巧妙，实现了时空合成运动的精确调控

## Spintronics

### 1. **[Tuning perpendicular magnetic anisotropy in ultra-low damping Li$_{0.5}$Al$_{x}$Fe$_{(2.5-x)}$O$_4$ thin films for efficient spin-orbit torque switching](https://arxiv.org/abs/2606.13573v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-11
- **作者**: Daisy O'Mahoney, Sauviz P. Alaei, Anna Janni et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 研发出低阻尼LAFO薄膜以实现高效自旋轨道转矩开关
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 材料性能优异，实验设计严谨，对自旋电子学贡献显著。

### 2. **[Morphology control and low-temperature magnetotransport in chiral 2D perovskite R-(MBA)$_2$PbI$_4$](https://arxiv.org/abs/2606.13664v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-11
- **作者**: Shehreen Aslam, Sam Saiter, Bradley Lloyd et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 实现手性钙钛矿薄膜横向电学输运表征
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破了材料高电阻瓶颈，为手性自旋电子学奠定基础

## Condensed Matter Physics

### 1. **[Lone-Pair-Induced Lattice Softness Enables Ultralow Thermal Conductivity in Hybrid Organic-Inorganic Perovskite GuaPbI$_3$](https://arxiv.org/abs/2606.13561v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-11
- **作者**: Rudra P. Singh, Shantanu Pathak, Saswata Bhattacharya et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用孤对电子诱导晶格软化实现超低热导率
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与实验，在热电材料设计上取得显著突破

### 2. **[Symmetry-electronic fingerprints reveal competing magnetic phases in two-dimensional materials](https://arxiv.org/abs/2606.13548v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-11
- **作者**: Addis Fuhr, Zachary R. Fox, David Parker et al.
- **标签**: `cond-mat.mtrl-sci` `physics.data-an` `stat.ML`
- **AI摘要**: 提出SEF表征以预测二维磁性材料相变
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对称性与电子结构结合提升了磁性预测的准确性与可解释性

### 3. **[Polarizing ultrathin ferroelectric BaTiO3 films through interfacial layer polarization](https://arxiv.org/abs/2606.13396v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-11
- **作者**: Ipek Efe, Edith Simmen, Tobias Goldenberger et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用SNO界面调控BTO薄膜极化
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过界面电荷调控实现单胞级铁电极化，方法严谨且创新。

### 4. **[Cepstral Analysis to accelerate Green-Kubo thermal conductivity calculations of Metal-Organic Frameworks](https://arxiv.org/abs/2606.13588v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-11
- **作者**: Florian P. Lindner, Egbert Zojer, Sandro Wieser
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用倒谱分析加速MOF热导率计算
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过倒谱分析优化GK模拟，显著提升了计算效率与稳定性。

### 5. **[Phonon polariton confinement in isotopically pure MOVPE-grown BN triangles](https://arxiv.org/abs/2606.13483v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-11
- **作者**: Maximilian Scharpey, Oskar Schröer, Daniel Wigger et al.
- **标签**: `cond-mat.mes-hall` `physics.optics`
- **AI摘要**: MOVPE生长BN中声子极化激元的受限与传播
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，证实了外延BN在纳米光子学的应用潜力。

## Theoretical Physics

### 1. **[A ribbon ZX calculus for gauge theory](https://arxiv.org/abs/2606.13551v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-11
- **作者**: Gabriel Wong, Razin A. Shaikh, William Donnelly
- **标签**: `hep-th` `cond-mat.other` `math-ph`
- **AI摘要**: 提出规范场论的ZX演算推广
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 将ZX演算与二维杨-米尔斯理论结合，具有理论创新性。
