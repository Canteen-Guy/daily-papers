...
### 1. **[Optical Poling Reveals Hidden Molecular Restructuring in Multimode Fibers, Unlocking Ultra-Efficient Third-Order Nonlinearities](https://arxiv.org/abs/2606.07444v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-05
- **作者**: Maxime Jonard, Thomas Larqué, Dan-Esli Bouyou Bouyou et al.
- **标签**: `physics.optics`
- **AI摘要**: 揭示光极化诱导二氧化硅分子重构机制
<details>
...
- **评分理由**: 发现光极化改变玻璃结构并增强非线性，极具创新性。

### 2. **[Multi-channel free-space optical convolutions with incoherent light](https://arxiv.org/abs/2606.07265v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-05
- **作者**: Alexander Song, Sai Nikhilesh Murty Kottapalli, Peer Fischer
- **标签**: `physics.optics`
- **AI摘要**: 提出多通道自由空间光学卷积方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强且实验验证充分，但应用场景有局限

### 3. **[Laser-Stabilized Fiber Sensing on Terrestrial Field-Deployed Cable for Enhanced Sensitivity](https://arxiv.org/abs/2606.07251v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-06-05
- **作者**: Rajiv Boddeda, Adrish Sahu, Christian Dorize et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用激光稳频提升光纤传感灵敏度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过优化技术提升了长距离分布式传感性能，具有实用价值。

## Metamaterials

### 1. **[Collective emission of subwavelengths atom-like emitter arrays in the presence of inhomogeneous broadening](https://arxiv.org/abs/2606.07458v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-05
- **作者**: Uri Israeli, Shahar Levi, Sagi Ben-Avi et al.
- **标签**: `physics.optics` `physics.atom-ph` `quant-ph`
- **AI摘要**: 实现固态量子阵列集体辐射
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破了非均匀展宽限制，实验与理论结合紧密。

### 2. **[Towards Engineering Material Neural Networks](https://arxiv.org/abs/2606.07262v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-05
- **作者**: Charles de Kergariou, Hortense le Ferrand, Ali Momeni et al.
...
- **评分理由**: 创新性强，将物理神经网络引入结构材料领域。

## Spintronics

### 1. **[Polar and quadratic magneto-optical Kerr effects in nonmagnetic/ferromagnet bilayers for spin-orbit torque measurements](https://arxiv.org/abs/2606.07395v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-05
- **作者**: Yukihiro Marui, Masashi Kawaguchi, Kohji Nakamura et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 验证MOKE测量自旋轨道转矩的可靠性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究通过对比MOKE与霍尔效应，证明了MOKE在表征自旋轨道转矩中的优势。

### 2. **[Skyrmions in Synthetic Antiferromagnets: Collapse and Nucleation](https://arxiv.org/abs/2606.07112v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-05
- **作者**: M. N. Potkina
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 研究合成反铁磁体中斯格明子对的坍缩与成核机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过晶格模型揭示了斯格明子对的动力学行为，理论严谨且具应用潜力。

## Condensed Matter Physics

### 1. **[Near-room-temperature magnetoelectric coupling engineered through inversion-breaking tilts in a bulk perovskite polytype](https://arxiv.org/abs/2606.07405v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-05
- **作者**: Struan Simpson, Urmimala Dey, Martin R. Lees et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用对称性设计实现室温磁电耦合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过结构失稳机制实现多铁性，方法创新且论证严谨。

### 2. **[Chromium chalcohalide Janus monolayer ferromagnets with perpendicular magnetic anisotropy and high Curie temperature](https://arxiv.org/abs/2606.07138v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-05
- **作者**: M. Bosnar, J. M. Lendinez, A. Yu. Vyazovskaya et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 发现CrXY Janus单层具有高居里温度与磁各向异性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论计算严谨，揭示了新型二维铁磁材料的磁性潜力

### 3. **[Scalable Prediction of Complex Surface Reconstructions under Operating Conditions via Harmony-Search-Based Global Optimization](https://arxiv.org/abs/2606.07396v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-05
- **作者**: Shi-Yang Chen, Xiao-Ming Cao
- **标签**: `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 提出HASGO框架实现催化表面重构预测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与和声搜索，有效提升复杂表面结构预测效率

### 4. **[Six Open Questions in Machine-Learned Interatomic Potential Foundation Models](https://arxiv.org/abs/2606.07327v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-05
- **作者**: Isabel Creed, Tim Rein, Ingvars Vitenburgs et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.dis-nn` `physics.app-ph`
- **AI摘要**: 探讨机器学习原子间势能模型的前沿挑战
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统梳理了基础模型在原子模拟中的关键开放性问题

### 5. **[Flexible PDMS/La$_{0.7}$Sr$_{0.3}$MnO$_3$/MWCNT Composite Thin Films for Multifunctional Temperature and Magnetic Sensing Electronic Skin](https://arxiv.org/abs/2606.07305v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-06-05
- **作者**: Jimlee Patowary, G. Suresh, Jitendra Kumar et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 研发柔性LSMO/MWCNT复合薄膜用于多功能传感
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 材料制备与多功能传感验证完整，但创新性中等。

## Theoretical Physics

### 1. **[On the conditional equivalence of phase retrieval algorithms](https://arxiv.org/abs/2606.07257v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-05
- **作者**: Jakob Schroeder, Andreas Döpp
- **标签**: `physics.optics` `cs.LG`
- **AI摘要**: 揭示相位恢复算法与梯度下降的数学等价性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且具有重要跨领域应用价值。

### 2. **[A homodyne detection scheme for all-optical photon-photon scattering experiments using 2D detectors](https://arxiv.org/abs/2606.07460v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-05
- **作者**: Timo Pohle, Leonard Doyle, Paul Ihde et al.
- **标签**: `hep-ex` `physics.optics`
- **AI摘要**: 提出平衡零拍探测方案以抑制光子散射背景噪声
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该方案有效提升了光子散射实验的信噪比，方法严谨且具有实用价值。

### 3. **[Experimental Demonstration of Free-Space Unidimensional Continuous-Variable Quantum Key Distribution Under High Detector Noise](https://arxiv.org/abs/2606.07206v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-05
- **作者**: Rachita Nandan, Jayanth Ramakrishnan, Shashi Prabhakar et al.
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 高噪声下自由空间UD-CVQKD实验演示
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验验证了高噪声环境下的量子密钥分发可行性

### 4. **[Normal forms of unidirectional coupling in quasi-phase-matched non-Hermitian systems](https://arxiv.org/abs/2606.07191v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-05
- **作者**: Kestutis Staliunas
- **标签**: `physics.optics`
- **AI摘要**: 揭示准相位匹配非厄米系统单向耦合的最优条件
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，纠正了关于奇异点单向耦合的传统认知。

### 5. **[Generalized analytical relations to describe global optical systems with a plenoptic camera](https://arxiv.org/abs/2606.07105v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-05
- **作者**: Marc Brunel, Pierre Schleuniger, Adrian Marszalek et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出光场相机全局光学系统解析模型
<details>
<summary>原始摘要</summary>
