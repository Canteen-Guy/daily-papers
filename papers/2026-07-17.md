...
### 1. **[Temporal Fourier Optics Reveals Hidden Hybridized Light-Matter States](https://arxiv.org/abs/2607.13957v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-15
- **作者**: Juan-Feng Zhu, Wenjie Zhou, Shihao Feng et al.
- **标签**: `physics.optics` `physics.app-ph` `quant-ph`
- **AI摘要**: 提出时空傅里叶光学框架以恢复隐藏的光物质耦合态。
<details>
...
- **评分理由**: 创新性地利用时域点扩散函数重构光谱，方法严谨且应用广泛。

### 2. **[Polariton Topological Insulators with Disclinations](https://arxiv.org/abs/2607.13948v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-15
- **作者**: Khalil Sabour, Yaroslav V. Kartashov
- **标签**: `physics.optics`
- **AI摘要**: 提出非线性极化激元拓扑绝缘体
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合拓扑缺陷与非线性效应，理论严谨且具创新性。

## Metamaterials

### 1. **[Magneto-optical hologram lens with microsecond focal switching in magnetic garnet](https://arxiv.org/abs/2607.13985v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-15
- **作者**: Hibiki Miyashita, Toshiaki Watanabe, Eri Negishi et al.
- **标签**: `physics.optics` `cond-mat.mtrl-sci`
- **AI摘要**: 实现微秒级磁光全息透镜快速切换
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验验证了磁光效应在透镜切换中的高速潜力，方法严谨。

## Spintronics

### 1. **[Ultrafast altermagnetophononics](https://arxiv.org/abs/2607.13863v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-15
- **作者**: Chenyu Wang, Yaxian Wang, Sheng Meng
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出利用相干声子调控反铁磁体自旋劈裂的新机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入声子调控反铁磁，理论严谨且应用前景广阔

### 2. **[Orbital Hybridization Induces Giant Cubic Rashba Effect at Cu/WO$_{3}$ Interface](https://arxiv.org/abs/2607.14069v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-15
- **作者**: Md Aktar Hossain, Saikat Das
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 揭示Cu/WO3界面巨大立方Rashba效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过第一性原理计算发现新型轻金属界面自旋轨道耦合机制

### 3. **[Electric field controlled spin transport in a topological insulator interfaced with a ferroelectric antiferromagnet](https://arxiv.org/abs/2607.14031v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-15
- **作者**: Yogesh Kumar, Pushpendra Gupta, Xinyan Li et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 实现铁电反铁磁界面电场调控自旋输运
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，揭示了拓扑绝缘体界面自旋转换机制，具有应用潜力。

## Condensed Matter Physics

### 1. **[The WEST code for large-scale excited-state materials simulations](https://arxiv.org/abs/2607.14025v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-15
- **作者**: Victor Wen-zhe Yu, Siyuan Chen, Yu Jin et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 发布高性能激发态材料模拟软件WEST
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法创新显著提升大规模计算效率，应用广泛且严谨。

### 2. **[Sail membranes for optomechanical accelerometry](https://arxiv.org/abs/2607.14089v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-15
- **作者**: Atkin D. Hyatt, Mitul Dey Chowdhury, Mahir Chowdhury et al.
- **标签**: `quant-ph` `cond-mat.mes-hall` `physics.app-ph`
- **AI摘要**: 研发新型帆状薄膜加速计，实现高灵敏度测量。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过贝叶斯优化设计，在低频与高Q值间取得突破。

### 3. **[Unified Terahertz Framework for Magnetic and Lattice Responses Reveals an Elusive Ordering Transition in Gd$_2$Ru$_2$O$_7$](https://arxiv.org/abs/2607.14029v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-15
- **作者**: Nicolas M. Kawahala, Rafael L. Sabainsk, Esteban Marulanda et al.
- **标签**: `cond-mat.str-el` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示Gd2Ru2O7中隐蔽的磁序相变
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用太赫兹光谱揭示磁晶耦合，方法创新且严谨。

### 4. **[Chemical short-range order controls deformation pathways in a complex concentrated alloy](https://arxiv.org/abs/2607.13896v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-15
- **作者**: Angelo F. Andreoli, Gabriela B. Ribeiro, Guilherme C. Stumpf et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示短程有序调控合金形变机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验与模拟结合严谨，深入阐明了CSRO对形变路径的影响。

### 5. **[Revealing the MoS2 Growth Mechanism in Chemical Vapor Deposition: Real-Time Imaging and Statistical Analysis](https://arxiv.org/abs/2607.13893v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-15
- **作者**: Faizal Arifurrahman, Tianshu Zhai, Yuguo Wang et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 通过原位成像揭示MoS2生长机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用图像处理技术实现高通量统计分析，方法创新且严谨。

## Theoretical Physics

### 1. **[Kaleidoscopic-ray-tracing-based model of the scintillation flash energy deposition in the photomultipliers attached to a strip scintillator](https://arxiv.org/abs/2607.13963v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-15
- **作者**: I. V. Vovchenko, T. M. Khamitov, L. V. Inzhechik
- **标签**: `physics.ins-det` `physics.optics`
- **AI摘要**: 提出万花筒光线追踪模型以加速闪烁体光传输模拟
<details>
<summary>原始摘要</summary>
