...
### 1. **[Double quantum spin Hall phase in bilayer ZrTe$_5$](https://arxiv.org/abs/2606.18130v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Chao Chen Ye, Gábor Kalla, Jianting Ye et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.other`
- **AI摘要**: 双层ZrTe5中实现双量子自旋霍尔相
<details>
...
- **评分理由**: 通过第一性原理揭示了新型拓扑相及其应变调控机制

### 2. **[Robust Signatures of Fragile Topology](https://arxiv.org/abs/2606.17870v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Viktor Könye, Ihor Nimyi, Oleg Janson et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示脆弱拓扑的鲁棒狄拉克锥特征
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新且结合第一性原理验证，具有高学术价值

## Topological Photonics

### 1. **[Kerr Soliton Generation in Ultra-Compact Photonic Devices](https://arxiv.org/abs/2606.18067v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Garrett J. Beals, Yun Zhao, Sai Kanth Dacha et al.
- **标签**: `physics.optics` `physics.app-ph`
- **AI摘要**: 实现紧凑微谐振器中克尔孤子稳定生成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过热模型与反馈回路解决了孤子热不稳定性

### 2. **[Broken-symmetry phenomena enhanced by quasi-bound states in the continuum](https://arxiv.org/abs/2606.18012v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Jan David Fischbach, Lukas Rebholz, Nikita Ustimenko et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用准BIC实现对称性破缺的增强光学响应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过准BIC机制揭示了对称性破缺的非线性效应，理论新颖且应用价值高。

### 3. **[On-sky binary source hypothesis testing beyond the diffraction limit using spatial mode demultiplexing based detection](https://arxiv.org/abs/2606.18025v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: John S. Wallis, Ayden S. McCann, Joshua J. Collier et al.
- **标签**: `astro-ph.IM` `physics.optics`
- **AI摘要**: 首次实现SPADE超衍射极限双星探测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 首次在轨验证SPADE技术，虽受损耗限制但优于直接成像。

### 4. **[Higher-order topological metasurface based on split-ring resonators with dipole-quadrupole couplings](https://arxiv.org/abs/2606.17855v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: Alina D. Rozenblit, Nikita A. Olekhno
- **标签**: `cond-mat.mes-hall` `physics.app-ph` `physics.optics`
- **AI摘要**: 提出基于SRR的微波高阶拓扑绝缘体超表面
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验验证充分，设计方案具有良好的实用性与可扩展性

### 5. **[Dual Line Coherent Detection](https://arxiv.org/abs/2606.17932v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-16
- **作者**: Nelson Castro, Yiming Li, Mohammed Patel et al.
- **标签**: `physics.optics` `eess.SP`
- **AI摘要**: 提出双线相干检测以提升频率偏移容限
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验验证了低成本相干收发器的可行性，方法创新且严谨。

## Metamaterials

### 1. **[Correlating Quasi-Optical Coupling Efficiency with Measured Receiver Noise Temperature in Metalens Coupled THz HEB Mixer](https://arxiv.org/abs/2606.18036v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: Jingqi Hu, Rui Wang, Jiameng Wang et al.
- **标签**: `physics.optics` `physics.ins-det`
- **AI摘要**: 提出金属透镜THz混频器耦合效率分析模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过理论与实验结合定量分析了金属透镜的耦合性能，方法严谨且具有工程应用价值。

## Spintronics

### 1. **[Coupled spin dynamics in epitaxial trilayer heterostructures of ferrimagnetic garnet](https://arxiv.org/abs/2606.18046v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: A. Del Giacco, M. J. Gross, O. Wojewoda et al.
- **标签**: `cond-mat.mtrl-sci` `physics.app-ph`
- **AI摘要**: 研究YIG三层异质结的耦合自旋动力学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验与模型结合紧密，对磁子学研究有参考价值

## Condensed Matter Physics

### 1. **[Anisotropic Short-Range Order Modulates Ferroelectric Switching in Wurtzite ScAlN Alloys](https://arxiv.org/abs/2606.18213v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Shunda Chen, Xianchao Dong, Xiaochen Jin et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示短程有序对ScAlN铁电翻转的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过第一性原理揭示微观结构对铁电性能的调控机制，理论严谨且具有创新性。

### 2. **[High-temperature ferromagnetism and antiferromagnetism in monolayer \ce{CrTe2}: Roles of strong spin-lattice coupling and charge doping](https://arxiv.org/abs/2606.18148v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Anupama S, Mukul Kabir
- **标签**: `cond-mat.str-el` `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示CrTe2磁性调控机制与室温磁序潜力
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合第一性原理与蒙特卡洛模拟，理论严谨且具应用价值。

### 3. **[Cavity-enhanced superconducting response in an underdoped cuprate](https://arxiv.org/abs/2606.18084v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Angela Montanaro, Vadim Plastovets, Nitesh Khatiwada et al.
- **标签**: `cond-mat.supr-con` `cond-mat.mes-hall` `physics.optics`
- **AI摘要**: 利用太赫兹腔增强欠掺杂铜氧化物超导相干性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计巧妙，理论模型支撑有力，具有重要科学意义。

### 4. **[Hydrogen s-electrons as the origin of crystal magnetism beyond spin-orbit coupling](https://arxiv.org/abs/2606.17902v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-16
- **作者**: Baiqiang Liu, Zhen Gong, Rui Liu et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.str-el` `physics.atom-ph`
- **AI摘要**: 发现氢s电子诱导的铁磁晶体新机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出s电子磁性新范式，理论严谨且具创新性

### 5. **[Impact of dynamic electrostatic disorder on hole mobility in rubrene: a nonadiabatic molecular dynamics investigation](https://arxiv.org/abs/2606.18090v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-16
- **作者**: Jan Elsner, Samuele Giannini, Jochen Blumberger
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示静电无序对红荧烯空穴迁移率的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过非绝热动力学模拟提升了电荷传输预测精度

## Theoretical Physics

### 1. **[Optimization of vacuum acceleration with radially polarized laser beams having phase aberrations](https://arxiv.org/abs/2606.17988v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-16
- **作者**: Spencer W. Jolly
- **标签**: `physics.optics` `physics.acc-ph`
- **AI摘要**: 利用球差优化径向偏振激光电子加速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过引入光学像差提升真空加速效率，方法新颖且逻辑清晰。
