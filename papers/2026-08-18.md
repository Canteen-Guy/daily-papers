...
### 1. **[Quasi-periodicity enforces Berry phase discontinuity in crystals](https://arxiv.org/abs/2608.14489v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Emanuele Maggio
- **标签**: `cond-mat.other`
- **AI摘要**: 揭示准周期性对贝里相位不连续性的影响
<details>
...
- **评分理由**: 理论推导严谨，首次利用准对称性解释非解析跳变。

## Topological Photonics

### 1. **[Full-field and Bloch-periodic-factor discretizations: Accuracy and phantom modes](https://arxiv.org/abs/2608.14348v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-14
- **作者**: Igor Tsukerman
- **标签**: `physics.optics` `math.NA`
- **AI摘要**: 分析布洛赫模态离散化方法的精度与伪模态问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 深入探讨了全场与周期因子法的数学差异及数值稳定性

## Metamaterials

### 1. **[Angular displacement readout of a mechanical oscillator with a guided mode resonance](https://arxiv.org/abs/2608.14447v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Diego Torres-Barajas, Oscar Angulo, Aman R. Agrawal et al.
- **标签**: `physics.optics` `cond-mat.mes-hall` `physics.ins-det`
- **AI摘要**: 利用导模共振实现高精度角位移测量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合导模共振与纳米机械振子，实验严谨且性能优异。

### 2. **[A Reflective Metasurface for High-Efficiency Terahertz Cross-Polarization Conversion](https://arxiv.org/abs/2608.14279v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-08-14
- **作者**: Muhammad Fayyaz Kashif, Shobit Agarwal, Antonio Iodice et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出一种高效率太赫兹交叉极化转换超表面
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 设计合理且实验验证充分，但在创新性上属于常规改进。

## Condensed Matter Physics

### 1. **[Universal Thermodynamic Interatomic Potentials for Crystalline Materials](https://arxiv.org/abs/2608.14502v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-14
- **作者**: Juno Nam, Bowen Deng, Xiaochen Du et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.stat-mech` `cs.AI`
- **AI摘要**: 提出热力学原子间势实现自由能高效计算
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新性强，显著提升材料热力学性质预测效率

### 2. **[Efficient simulation of second-order phase transitions in quantum anharmonic materials](https://arxiv.org/abs/2608.14292v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-14
...
- **评分理由**: 计算复杂度大幅降低，在强非谐材料模拟中具有重大突破。

### 3. **[Learning Spin Hamiltonians from Terahertz Two-Dimensional Coherent Spectroscopy](https://arxiv.org/abs/2608.14460v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Martin Mootz, Chuankun Huang, Liang Luo et al.
- **标签**: `physics.comp-ph` `cond-mat.str-el` `physics.optics`
- **AI摘要**: 利用机器学习从THz光谱推断自旋哈密顿量参数
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与非线性光谱，为量子材料参数反演提供了新范式。

### 4. **[Unraveling the Roles of Shallow, Deep and Auger Trapping in Charge Carrier Recombination in Triple-Cation Perovskites](https://arxiv.org/abs/2608.14368v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Jitendra Kumar, Thomas Kirchartz, Alexandr Marunchenko et al.
- **标签**: `cond-mat.mtrl-sci` `physics.optics`
- **AI摘要**: 揭示钙钛矿中陷阱与俄歇复合机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 多维度实验结合建模，深入解析了载流子复合机理。

### 5. **[Orbital Hall Effect in Weyl Semimetals from quantum geometric band interference](https://arxiv.org/abs/2608.14353v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-14
- **作者**: Chiara Pacella, Maximilian Ünzelmann, Ahmed Osman et al.
- **标签**: `cond-mat.mtrl-sci` `quant-ph`
- **AI摘要**: 揭示外尔半金属中轨道霍尔效应的几何起源
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合第一性原理与解析模型，深入阐明了轨道输运机制。

## Theoretical Physics

### 1. **[Krylov complexity and Berry phase in quantum adiabatic dynamics](https://arxiv.org/abs/2608.14325v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-08-14
- **作者**: Han-Qi Zheng, Peng-Zhang He, Lei-Hua Liu et al.
- **标签**: `quant-ph` `cond-mat.other` `hep-th`
- **AI摘要**: 揭示了量子绝热演化中Krylov复杂度与Berry相位的关联。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，创新性地将Krylov复杂度应用于绝热动力学分析。

### 2. **[GPU implementation of mixed quantum-classical Liouville molecular dynamics without momentum jump](https://arxiv.org/abs/2608.14544v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-08-14
- **作者**: Koji Ando
- **标签**: `physics.chem-ph` `cond-mat.mtrl-sci` `physics.comp-ph`
- **AI摘要**: 实现无跳跃量子经典Liouville动力学GPU加速
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过消除轨迹生成优化了GPU并行效率，具有实用价值。
