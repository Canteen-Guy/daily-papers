...
### 1. **[Topological cell-openness index for porous materials](https://arxiv.org/abs/2605.22761v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Michał Bogdan, Paweł Dłotko
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci`
- **AI摘要**: 提出基于贝蒂数的孔隙开放度指标
<details>
...
- **评分理由**: 利用拓扑方法量化孔隙结构，方法创新且逻辑严密。

## Topological Photonics

### 1. **[All-band photonic integrated optical parametric amplification](https://arxiv.org/abs/2605.22704v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Nikolai Kuznetsov, Zihan Li, Tobias J. Kippenberg
- **标签**: `physics.optics` `physics.app-ph`
- **AI摘要**: 基于PPLT芯片实现全频段光参量放大
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破性实现超宽带高增益放大，技术指标极佳。

### 2. **[A Non-Volatile Heterogeneous Quantum Dot III-V/Si DFB Laser with Optical Memristive Behavior](https://arxiv.org/abs/2605.22577v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Stanley Cheung, Bassem Tossoun, Di Liang et al.
- **标签**: `physics.optics`
- **AI摘要**: 研制出具备光忆阻特性的非易失性量子点激光器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合光子存储与激光技术，应用前景广阔

## Metamaterials

### 1. **[Agentic metasurface design with self-correcting language-model systems](https://arxiv.org/abs/2605.22647v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Bei Wu, Bo Xiong, Haiyao Luo et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出MetaDesigner实现超构表面自主设计与自修正
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入自修正代理系统，显著提升复杂光学设计效率

### 2. **[Extreme Optical Field Confinement and Enhancement in a Plasmonic Picopatch within a Nanoparticle-on-Mirror Resonator](https://arxiv.org/abs/2605.22780v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Jinna He, Mario Zapata-Herrera, Xabier Arrieta et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出纳米腔皮片结构实现极高光场局域与增强
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论模型严谨，对纳米光子学领域有重要参考价值。

## Spintronics

### 1. **[Magnon-mediated microwave to optical time dynamics](https://arxiv.org/abs/2605.22772v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Rajkumar Jadhav, Xinglin Zeng, Cedric Traub et al.
- **标签**: `physics.optics`
- **AI摘要**: 实现微波至光域的实时磁子动力学转换
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过光磁调制技术实现了磁子动力学的时间域测量

### 2. **[Antiferromagnetic Ordering Enhanced Magnetic Damping in Mn2Au/CoFeB Bilayers](https://arxiv.org/abs/2605.22382v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-21
- **作者**: Donghang Xie, Haozhe Wang, Zhe Zhang et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.other`
- **AI摘要**: 揭示Mn2Au/CoFeB双层膜中反铁磁序增强磁阻尼机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，深入探讨了反铁磁/铁磁界面动力学，具有学术价值。

## Condensed Matter Physics

### 1. **[Observation of magnetically switchable quantum geometric photocurrents](https://arxiv.org/abs/2605.22518v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Qi Tian, Zhuoliang Ni, Matthew Cothrine et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 首次观测到磁性可控量子几何光电流
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验验证了磁性材料中光电流的几何起源，具有重大突破。

### 2. **[Hyperdoped silicon photodetectors enable room-temperature computational SWIR imaging at 1550 nm](https://arxiv.org/abs/2605.22470v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-21
- **作者**: Xiaolong Liu, Sören Schäfer, Jinyuan Chen et al.
...
- **评分理由**: 突破硅基红外探测瓶颈，实验严谨且应用前景广阔。

### 3. **[Atomic scale demonstration of ferromagnetism in a single layer FeCl2 on Au(111)](https://arxiv.org/abs/2605.22783v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Adriana E. Candia, Eliecer Peláez-Sifonte, Amitayush Jha Thakur et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 证实单层FeCl2在金表面的铁磁性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验方法严谨，首次观测到原子尺度铁磁性

### 4. **[A Local Probe Mass Spectrometer for Localized and Sensitive Product Detection in Environmental Electron Microscopy](https://arxiv.org/abs/2605.22626v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Saleh Firoozabadia, Timofei Ivanova, Frederik Stendera et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 开发局部探针质谱联用技术
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决ETEM产物检测稀释问题，实验设计严谨。

### 5. **[Upscaling DFT-trained machine-learning interatomic potential toward Quantum Monte Carlo accuracy: Sulfur-vacancy migration in monolayer MoS$_2$ as a testbed](https://arxiv.org/abs/2605.22601v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-21
- **作者**: Adam Hložný, Ján Brndiar, Ye Luo et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出多保真度MLIP训练法以实现QMC精度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过多保真度学习提升DFT势函数精度，方法创新且实用。

## Theoretical Physics

### 1. **[Hollow Needle Puncture Mechanics for Biopsy Sampling](https://arxiv.org/abs/2605.22790v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Yiting Wu, Frederic Lechenault, Matteo Ciccotti et al.
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci`
- **AI摘要**: 建立空心针穿刺组织力学模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型结合断裂力学与摩擦力，对生物组织穿刺预测精准。

### 2. **[Scattering correction for infrared spectra of biological cells using computational infrared microspectroscopy and deep learning](https://arxiv.org/abs/2605.22503v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-21
- **作者**: Sergio G. Rodrigo, Ilia L. Rasskazov, Luis Martin-Moreno et al.
- **标签**: `physics.optics`
- **AI摘要**: 基于FDTD与深度学习的红外光谱散射校正方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用计算模型与深度学习解决生物细胞散射难题，方法创新且严谨
