...
### 1. **[Transmission of signals in the 300 GHz band with a bit-error rate below ${10}^{-9}$ using a soliton comb](https://arxiv.org/abs/2605.12348v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-12
- **作者**: Mantaro Imamura, Ryo Sugano, Ayaka Yomoda et al.
- **标签**: `physics.optics`
- **AI摘要**: 首次利用孤子微梳实现300GHz频段无误码信号传输。
<details>
...
- **评分理由**: 实验展示了低复杂度的太赫兹光子链路，对未来6G通信具有重要参考价值。

## Metamaterials

### 1. **[Enhanced Impact Mitigation via 3D-Multilayered Material Architectures](https://arxiv.org/abs/2605.12093v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Thomas Butruille, Joshua C. Crone, Carlos M. Portela
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出多层异质结构提升抗冲击性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分层设计显著提升轻量化材料能量耗散效率

### 2. **[Strong light enhancement by combining the photonic nanojet and plasmons from the nano-engineered microsphere](https://arxiv.org/abs/2605.11962v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-05-12
- **作者**: Vlatko Gašparić, Mile Ivanda, Davor Ristić et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出一种结合光子纳米喷注与等离激元的新型增强装置。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 设计创新且实用性强，但仅基于数值模拟，缺乏实验验证。

## Condensed Matter Physics

### 1. **[Probing Non-Equilibrium Grain Boundary Dynamics with XPCS and Domain-Adaptive Machine Learning](https://arxiv.org/abs/2605.12194v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Mouyang Cheng, Bowen Yu, Chu-Liang Fu et al.
- **标签**: `cond-mat.mtrl-sci` `cs.LG`
- **AI摘要**: 利用XPCS与机器学习揭示晶界非平衡动力学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合先进表征与AI算法，有效提取晶界动力学参数，创新性强。

### 2. **[Emergent Vortex Ordering in a Multiflavor Pyrochlore-Lattice Compound GeCo$_2$O$_4$](https://arxiv.org/abs/2605.12042v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-12
- **作者**: Jiajun Mo, Otkur Omar, Shuangkui Guang et al.
- **标签**: `cond-mat.str-el` `cond-mat.mtrl-sci`
- **AI摘要**: 发现GeCo2O4中涌现涡旋晶格及Kitaev相互作用
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合中子散射与回归分析，揭示了三维磁性材料的新序态。

### 3. **[Automated multiphase identification and refinement in powder diffraction using mismatch-tolerant machine learning](https://arxiv.org/abs/2605.12478v1)**
- **评分**: ⭐ 80/100 | **日期**: 2026-05-12
- **作者**: Lalit Yadav, Yongqiang Cheng, Mathieu Doucet
- **标签**: `cond-mat.mtrl-sci` `cond-mat.str-el`
- **AI摘要**: 提出RADAR-PD框架，实现自动化的多相衍射识别与精修。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与物理约束，显著提升了中子和X射线衍射分析的自动化水平。

### 4. **[Ordering governs magnetic tunability in FePt-based Janus particles independent of curvature](https://arxiv.org/abs/2605.12283v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Natalia Gonzalez-Vazquez, Eylül Suadiye, Eberhard Goering et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 揭示FePt Janus粒子磁性受晶体有序度而非曲率影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实验与模拟，量化了微米尺度磁性行为的物理机制，严谨且具实用价值。

### 5. **[Understanding oxide-thickness-dependent variability in dense Si-MOS quantum dot arrays](https://arxiv.org/abs/2605.12143v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-12
- **作者**: Arne Loenders, Jacques Van Damme, Clement Godfrin et al.
- **标签**: `quant-ph` `cond-mat.mtrl-sci`
- **AI摘要**: 优化氧化层厚度以提升硅量子点阵列均匀性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过大规模实验量化了氧化层厚度对量子点性能的影响

## Theoretical Physics

### 1. **[General and concise operator approach to the dyadic Green's function of layered media](https://arxiv.org/abs/2605.12346v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-12
- **作者**: Aliaksandr Arlouski, Lei Gao, Dongliang Gao et al.
- **标签**: `physics.optics` `math-ph`
- **AI摘要**: 提出一种用于各向异性分层介质并矢格林函数推导的通用算符方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该方法通过算符简化了格林函数的数学处理，对纳米光子学计算具有重要理论与实用价值。
