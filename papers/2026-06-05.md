...
### 1. **[Multi-dimensional parameter space of higher-order exceptional points induced by Brillouin optoacoustics](https://arxiv.org/abs/2606.05064v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-03
- **作者**: Grigorii Slinkov, Anton Montag, Julius T. Gohsrich et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用布里渊散射实现光纤三阶奇异点
<details>
...
- **评分理由**: 实验方法创新，无需微纳加工，拓扑物理应用价值高。

## Metamaterials

### 1. **[Influence of anisotropy on the expansion performance of auxetic skin meshing geometries: a finite element study](https://arxiv.org/abs/2606.04893v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-03
- **作者**: Masoumeh Razaghi Pey Ghaleh, Denis O'Mahoney, Kevin Moerman
- **标签**: `physics.med-ph` `cond-mat.mtrl-sci`
- **AI摘要**: 研究各向异性对辅助皮肤网格扩张性能的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过有限元分析揭示了皮肤各向异性对网格扩张的复杂影响

## Condensed Matter Physics

### 1. **[Autonomous heterogeneous catalyst discovery with a self-evolving multi-agent digital twin](https://arxiv.org/abs/2606.05050v1)**
- **评分**: ⭐ 92/100 | **日期**: 2026-06-03
- **作者**: Zhilong Song, Zongmin Zhang, Lixue Cheng
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 开发CatDT数字孪生系统实现高效催化剂自主发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 多智能体架构显著提升催化模拟精度与效率，具有重大应用价值

### 2. **[MicroCup: A Cryogenic Specimen Preparation Strategy for Atom Probe Tomography of Organic Molecular Liquids](https://arxiv.org/abs/2606.05147v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-03
- **作者**: Kuan Meng, Florian Groll, Sebastian Eich et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.soft`
- **AI摘要**: 提出MicroCup策略实现液态有机物原子探针层析成像
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新制备方法解决了液态样品APT成像难题，实验严谨且具有高应用价值。

### 3. **[Exchange-mediated exciton splitting and linear dichroism in monolayer transition metal dichalcogenide induced by ferroelectric substrates](https://arxiv.org/abs/2606.05093v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-03
- **作者**: Sudipta Kundu, Felipe H. da Jornada
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 铁电衬底诱导TMD激子劈裂与线性二色性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用第一性原理揭示了铁电衬底对激子态的调控机制，方法严谨且具有应用潜力。

### 4. **[Berry-Curvature Activation by Orbital Flux in a Kagome Altermagnet](https://arxiv.org/abs/2606.04984v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-03
- **作者**: Meysam Bagheri Tagani, Carmine Autieri
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示轨道磁通驱动的笼目反铁磁拓扑响应机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，系统阐述了非共线磁结构中的拓扑物理。

### 5. **[Bulk and surface excitons in the van der Waals magnet CrSBr: Magneto-optical studies to 55 tesla](https://arxiv.org/abs/2606.05057v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-03
- **作者**: Junho Choi, Yihyun Moon, Doohyeon Lee et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示CrSBr中体与表面激子的磁光特性差异
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过高磁场实验验证了激子局域环境差异，方法严谨。

## Theoretical Physics

### 1. **[Wave-optical formulation of the image-rotation property in Dove prisms: A Fourier-optics approach](https://arxiv.org/abs/2606.05027v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-03
- **作者**: Nima Keramati, S. Faezeh Mousavi, Amirnader Askarpour et al.
- **标签**: `physics.optics` `physics.app-ph`
- **AI摘要**: 利用傅里叶光学推导Dove棱镜旋转成像公式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过波动光学严谨证明了棱镜旋转特性，理论完备且实用。

### 2. **[Polalrized reservoirs in dynamics of polariton condensation](https://arxiv.org/abs/2606.04808v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-03
- **作者**: I. A. Shelykh, A. V. Yulin
...
- **评分理由**: 通过自旋密度矩阵修正了储层耦合理论，严谨且具理论价值。
