...
### 1. **[Comb-enabled spectral-domain image transport through perturbation-prone multimode fibers](https://arxiv.org/abs/2606.30203v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-29
- **作者**: Maohan Li, Zijian Wang, Bowen Sun et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用双光梳实现抗扰动多模光纤成像
<details>
...
- **评分理由**: 创新性引入光梳编码与神经网络，显著提升了光纤成像的鲁棒性与速度。

### 2. **[Quantization and Biphoton Statistics of k-Gap Solitons in Nonlinear Photonic Time Crystals](https://arxiv.org/abs/2606.30508v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-29
- **作者**: Liang Zhang, Chenhao Pan, Yiming Pan
- **标签**: `physics.optics` `nlin.PS` `quant-ph`
- **AI摘要**: 揭示非线性光子时间晶体中k带隙孤子的量子统计特性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，建立了光子时间晶体量子化框架

### 3. **[Exact Helicity-Orbital Coupled Dynamics in Chiral Media: An Optical Dirac Framework for Photonic Rabi Oscillations](https://arxiv.org/abs/2606.30295v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-29
- **作者**: Xuhui Cheng, Longlong Feng
- **标签**: `physics.optics` `quant-ph`
- **AI摘要**: 提出手性介质中光子狄拉克方程与拉比振荡框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架严谨且具有创新性，对光子学研究有启发

### 4. **[All-optical switching of continuous-variable entanglement in an absorption-suppressed plasmonic nanodimer](https://arxiv.org/abs/2606.30315v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-29
- **作者**: Elif Ozturk, Mehmet Gunay, Ramazan Sahin et al.
- **标签**: `quant-ph` `cond-mat.mes-hall` `physics.optics`
- **AI摘要**: 提出一种低损耗可调谐量子等离激元纳米二聚体开关
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性结合等离激元与量子纠缠，理论严谨且具备应用潜力

### 5. **[All-Optical Control of Birefringence in a Cold Atomic Ensemble](https://arxiv.org/abs/2606.30216v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-29
- **作者**: Apoorva Apoorva, Naudson Lucas Lopes Matias, Bérengère Pinoche et al.
...
- **评分理由**: 实验设计巧妙，实现了光控偏振的高效调节。

## Metamaterials

### 1. **[Arduino based interferometer stabilizer equipped with a digital lock-in amplifier](https://arxiv.org/abs/2606.30199v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-06-29
- **作者**: Giuseppe Emanuele Lio, Saravanan Rajamani, Alessandro Pitanti et al.
- **标签**: `physics.optics` `physics.ins-det`
- **AI摘要**: 基于Arduino的低成本干涉仪数字锁相稳频系统
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用低成本微控制器实现高精度稳频，实用性强且逻辑清晰。

## Spintronics

### 1. **[Rolling Two-Dimensional Collinear Magnets into Chiral Nanotubes with $p$-Wave Magnetism](https://arxiv.org/abs/2606.30214v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-29
- **作者**: Zhejunyu Jin, Robin R. Neumann, Rodrigo Jaeschke-Ubiergo et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 磁性纳米管实现p波磁性与高效自旋转换
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，为非常规自旋电子学提供新路径

## Condensed Matter Physics

### 1. **[Excitons in Large Disordered Boron-Nitride Layer using Linear-Scaling Bethe-Salpeter Simulations](https://arxiv.org/abs/2606.30585v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-29
- **作者**: Thomas Galvani, Lorenzo Sponza, Hakim Amara et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出线性标度Bethe-Salpeter方法模拟大尺度激子。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法突破了传统计算瓶颈，在大尺度无序体系应用广泛。

### 2. **[Hidden Defect Chemistry in Ion-Irradiated MoS$_2$ Field-Effect Transistors Revealed by Photocurrent Loss](https://arxiv.org/abs/2606.30361v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-29
- **作者**: L. Daniel, D. Sutarma, L. Klieve et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示碳污染掩盖MoS2缺陷化学
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实验与DFT计算，揭示了表面污染对缺陷工程的影响，逻辑严密。

### 3. **[Beyond Drug Discovery: The Nanotechnology Molecular Optimization (NMO) Benchmark](https://arxiv.org/abs/2606.30170v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-29
- **作者**: Matthias Blaschke, Daniel Kienzle, Zsuzsanna Koczor-Benda et al.
- **标签**: `cs.LG` `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 提出NMO基准以推动纳米材料的生成式设计。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过量子模拟替代代理模型，显著提升了科学严谨性。

### 4. **[Phonon-driven Floquet-Bloch states probed by quantum beat spectroscopy](https://arxiv.org/abs/2606.30065v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-29
- **作者**: Yu-Chan Tai, Chih-Wei Luo, Noriaki Takagi et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用相干声子实现长寿命Floquet-Bloch态
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，创新性地利用声子驱动量子态。

### 5. **[Synthesizability and Mechanical Properties of High-Entropy Borides: First-Principles and Machine Learning Studies](https://arxiv.org/abs/2606.30540v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-29
- **作者**: Luke Moore, Ethan Fox, Bria Storr et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 结合DFT与ML预测高熵硼化物的合成性与力学性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且系统，通过计算筛选材料，具有较好的应用潜力

## Theoretical Physics

### 1. **[Improving Beam Quality in Gravitational-Wave Interferometers Illuminated by Higher-Order Laguerre-Gaussian Modes](https://arxiv.org/abs/2606.30210v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-29
- **作者**: Liu Tao, Yuefan Guo, Alberto Gatto et al.
- **标签**: `astro-ph.IM` `physics.optics`
- **AI摘要**: 提出掩模法提升LG模式引力波探测性能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过掩模技术有效抑制寄生模式，提升了光学性能。

### 2. **[Connecting Density Matrix Spectroscopy to Biexciton Entanglement Dynamics](https://arxiv.org/abs/2606.30424v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-06-29
- **作者**: Yusuke Masaki, Takashi Otaki, Hiroaki Matsueda
- **标签**: `quant-ph` `cond-mat.mes-hall` `cond-mat.str-el`
- **AI摘要**: 揭示DMS与双激子纠缠动力学的解析关系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，有效验证了DMS在纠缠探测中的应用价值。
