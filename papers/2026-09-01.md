...
### 1. **[How Long-Range Tails Reshape Non-Hermitian Spectra](https://arxiv.org/abs/2608.28577v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-28
- **作者**: Ding Gu, Zhanpeng Fu, Yu-Min Hu et al.
- **标签**: `quant-ph` `cond-mat.mes-hall` `cond-mat.quant-gas`
- **AI摘要**: 揭示了长程跳跃对非厄米系统能谱及皮肤效应的非微扰重构。
<details>
...
- **评分理由**: 理论严谨，深入探讨了长程相互作用对非厄米能谱的显著影响。

## Topological Photonics

### 1. **[Structural perturbation theory for bound states in the continuum via bifurcation of zeros and extrema of the dispersion relation](https://arxiv.org/abs/2608.28321v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-28
- **作者**: Lijun Yuan, Ya Yan Lu
- **标签**: `physics.optics`
- **AI摘要**: 提出BIC扰动理论并揭示其与LTM的演化关系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论框架严谨，对BIC与非厄米系统的分析具有深度。

## Spintronics

### 1. **[Magnonic Combinatorial Memory based on a network of coupled active ring circuits](https://arxiv.org/abs/2608.28457v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-28
- **作者**: Mykhaylo Balinskiy, Paulo Julio, Jeffrey Vargas et al.
- **标签**: `cond-mat.other`
- **AI摘要**: 提出基于耦合有源环路网络的磁振子组合存储器
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地利用磁振子路径编码，实验验证了高存储密度。

## Condensed Matter Physics

### 1. **[Wyckoff-Resolved Oxidation-State Atlas and Anion-Conditioned Priors for Materials Discovery](https://arxiv.org/abs/2608.28492v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-28
- **作者**: Boris Kiefer
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出Wyckoff解析氧化态图谱以优化材料发现
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且覆盖率提升显著，具有较强实用价值。

### 2. **[Optomechanical inertial reference for atom interferometry](https://arxiv.org/abs/2608.28418v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-28
- **作者**: A. Rajagopalan, K. Stolzenberg, D. Thomas et al.
- **标签**: `quant-ph` `physics.atom-ph` `physics.optics`
- **AI摘要**: 提出光机谐振器与原子干涉仪的混合惯性传感架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地融合了光机与原子传感，显著提升了抗噪性能。

### 3. **[Topological Signatures of Hardness and Structural Order in Network-Forming Materials](https://arxiv.org/abs/2608.28365v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-28
- **作者**: Yair Augusto Gutiérrez Fosado, Ayobami Daramola, Davide Marenduzzo et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.other`
- **AI摘要**: 引入拓扑连接价以揭示网络材料结构与硬度关系
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过拓扑描述符有效区分了硅材料的力学性质与结构特征

### 4. **[Crystal-phase quantum dots in AlGaAs nanowires](https://arxiv.org/abs/2608.28353v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-28
- **作者**: Rohan Radhakrishnan, Rodion Reznik, Gilles Patriarche et al.
- **标签**: `cond-mat.mes-hall` `physics.optics` `quant-ph`
- **AI摘要**: 首次实现AlGaAs纳米线晶相量子点，提升光学性能。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过材料创新显著改善了量子点发射质量，实验严谨。

### 5. **[Work Function and High-Coverage Adsorption Energy as Hydrogen-Evolution Descriptors on Ag-Au-Pd-Pt Alloys](https://arxiv.org/abs/2608.28347v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-28
- **作者**: Zacharias Liasi, Ridha Zerdoumi, Felix Thelen et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示功函数与吸附能作为析氢活性描述符的有效性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与实验，系统评估了多金属合金的催化性能描述符。

## Theoretical Physics

### 1. **[Input-Output Analysis of Quantum Dot SUPER Excitation](https://arxiv.org/abs/2608.28470v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-28
- **作者**: Johannes Kerber, Christoph Hotter, Helmut Ritsch et al.
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 提出量子点SUPER激发的输入输出分析方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过累积量展开法解决了大光子数下的量子动力学计算难题

### 2. **[Correlation Swapping: a correlator for independent thermal light sources](https://arxiv.org/abs/2608.28454v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-28
- **作者**: Wanting Hou, Jilun Zhao, Zhiyuan Ye et al.
- **标签**: `physics.optics` `physics.app-ph`
- **AI摘要**: 提出经典关联交换方案实现热光源空间关联调控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入经典关联交换，实验验证有效且应用前景广阔。

### 3. **[Langevin Theory of Non-Markovian Quantum Dynamics: Application to Delayed Coherent Feedback and the Laser Linewidth](https://arxiv.org/abs/2608.28506v1)**
- **评分**: ⭐ 77/100 | **日期**: 2026-08-28
- **作者**: Marc Cuenca-Laràs, Ming Li, Carlos Navarrete-Benlloch et al.
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 将相空间朗之万方法扩展至非马尔可夫量子动力学并应用于激光线宽。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该研究创新性地将相空间方法应用于非马尔可夫系统，理论严谨且具有较强的实用价值。
