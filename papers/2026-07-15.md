...
### 1. **[Drill-bit-inspired dynamic focal fields for augmented laser materials processing](https://arxiv.org/abs/2607.11553v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-13
- **作者**: Evangelos Skoulas, Pinku Yadav, Justin Hidjam et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出钻头式动态激光焦场以提升加工效率
<details>
...
- **评分理由**: 创新性强，实验严谨，对激光制造有显著应用价值

### 2. **[Phase synchronization dynamics of two mutually coupled InP lasers in a quantum entropy source](https://arxiv.org/abs/2607.11806v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-13
- **作者**: Berta Martínez-Pàmias, Miquel Rudé, Cristina Masoller
- **标签**: `physics.optics`
- **AI摘要**: 量化耦合对InP激光器熵源的影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实验与模型分析相位同步，具有实用价值。

## Metamaterials

### 1. **[Spacer-Mediated Gold Nanocube Arrays for Edge-Localized Excitonic Enhancement in Monolayer MoS2](https://arxiv.org/abs/2607.11768v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-13
- **作者**: Abdullah Efe Yildiz, Emre Ozan Polat
- **标签**: `physics.optics` `physics.app-ph` `physics.comp-ph`
- **AI摘要**: 金纳米立方阵列增强单层MoS2激子效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过等离激元调控实现了MoS2激子发射的高效增强

### 2. **[The Dielectric Bowtie Effect: Classical Electromagnetic Edge Singularities in Subwavelength Cavities](https://arxiv.org/abs/2607.11613v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-13
- **作者**: Valdemar Bille-Lauridsen, Jesper Mørk
- **标签**: `physics.optics`
- **AI摘要**: 揭示介质蝶形腔电磁场奇点机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨且物理图像清晰，具有较高学术价值

## Condensed Matter Physics

### 1. **[Direct writing of individual quantum dots](https://arxiv.org/abs/2607.11864v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-13
- **作者**: Weikun Zhu, Natalie Ngoh, Shelly Ben-David et al.
- **标签**: `cond-mat.mtrl-sci` `physics.optics`
- **AI摘要**: 实现钙钛矿量子点定点直写与集成
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过热扫描探针实现量子点精准合成与集成，技术创新性强。

### 2. **[A diode nanocavity for fast, efficient and tunable emission of highly entangled photon pairs and Fourier-transform-limited single photons](https://arxiv.org/abs/2607.11494v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-07-13
- **作者**: Ievgen Brytavskyi, Thomas Oberleitner, Christian Weidinger et al.
...
- **评分理由**: 器件性能优异，在量子光源领域具有重要应用价值

### 3. **[Universal scalings and switching entropy in yield-stress fluids](https://arxiv.org/abs/2607.11799v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-13
- **作者**: Rajam Elancheliyan, Jean Marc Fromental, Edouard Chauveau et al.
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示屈服应力流体的普适标度与熵增机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论模型创新且严谨，对非线性流变学有重要贡献

### 4. **[CatRetriever: Contrastive Representation Learning for Slab-to-Bulk Retrieval in Generative Catalyst Discovery](https://arxiv.org/abs/2607.11712v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-13
- **作者**: Jungho Oh, Woosung Kim, Dong Hyeon Mok et al.
- **标签**: `cs.LG` `cond-mat.mtrl-sci`
- **AI摘要**: 提出CatRetriever实现催化剂板材到块体检索
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对比学习解决催化剂结构检索难题，方法创新且实用。

### 5. **[Correlation-consistent Gaussian basis sets for copper solids from material-constrained atomic optimization](https://arxiv.org/abs/2607.11711v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-13
- **作者**: Jincheng Yu, Xiaoyu Zhang, Min-Ye Zhang et al.
- **标签**: `physics.chem-ph` `cond-mat.mtrl-sci`
- **AI摘要**: 提出MCAO方法优化铜基组以解决固体计算线性相关问题
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该方法有效解决了高斯基组在周期性体系中的数值稳定性问题，具有较高学术价值。

## Theoretical Physics

### 1. **[Optimal tomography of bosonic and fermionic Gaussian states](https://arxiv.org/abs/2607.11847v1)**
- **评分**: ⭐ 85/100 | **日期**: 2026-07-13
- **作者**: Senrui Chen, Marco Fanizza, Filippo Girardi et al.
- **标签**: `quant-ph` `cond-mat.other` `math-ph`
- **AI摘要**: 确定了高斯态量子层析的样本复杂度
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 解决了量子信息领域关于高斯态学习的长期公开问题

### 2. **[Analytical Markov Chain for Spatiotemporal Flux Evolution of the Inner Filter Effect in Fluorescent Media](https://arxiv.org/abs/2607.11815v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-07-13
- **作者**: Xuhui Yang, Guofu Cao
- **标签**: `hep-ex` `physics.optics`
- **AI摘要**: 提出马尔可夫模型以高效解析荧光内滤效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解析模型显著提升了荧光光谱计算效率，方法严谨且实用。

### 3. **[Analytical Theory of Photon Tunneling and Near-Field Heat Transfer Between Dissimilar Materials](https://arxiv.org/abs/2607.11671v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-13
- **作者**: Kartika N. Nimje, Mariano Pascale, Georgia T. Papadakis
- **标签**: `physics.optics`
- **AI摘要**: 推导异质材料近场热辐射解析解
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提供了异质界面热传递的闭式解析框架，理论严谨。

### 4. **[How do 3M Command strips work? A fracture mechanics approach](https://arxiv.org/abs/2607.11650v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-13
- **作者**: Xue-Ling Luo, Nikolaos Bouklas, Chung-Yuen Hui
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci` `physics.comp-ph`
- **AI摘要**: 建立3M胶带拉伸释放的断裂力学模型
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过解析解与有限元分析揭示了胶带剥离的力学机制

### 5. **[Axion Generation in a Three-Dimensional Optical Trap](https://arxiv.org/abs/2607.11589v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-13
- **作者**: Chunyu Zhang, Xinran Fang, Lichen Peng et al.
- **标签**: `physics.optics` `hep-ex` `hep-ph`
- **AI摘要**: 提出光学纺锤阱实现轴子产生与探测
<details>
<summary>原始摘要</summary>
