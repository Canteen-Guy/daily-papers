...
### 1. **[Emergence of synthetic twist defects in the surface code under local perturbation](https://arxiv.org/abs/2605.10839v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-05-11
- **作者**: Paul Kairys, Phillip C. Lotshaw
- **标签**: `quant-ph` `cond-mat.other`
- **AI摘要**: 研究了表面码中局部扰动诱导合成扭曲缺陷的能谱与相变。
<details>
...
- **评分理由**: 填补了合成缺陷理论的研究空白，通过多语言表述和数值计算验证了相变。

## Topological Photonics

### 1. **[Pulse, polarization and topology shaping of polariton fuids](https://arxiv.org/abs/2605.10403v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Lorenzo Dominici, David Colas, Stefano Donati et al.
- **标签**: `cond-mat.other` `cond-mat.quant-gas` `physics.optics`
- **AI摘要**: 利用极化激元流体实现超快拓扑态操控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究通过量子流体平台实现拓扑态调控，创新性与严谨性较强。

## Metamaterials

### 1. **[Design strategies for efficient, fabrication-feasible extreme-ultraviolet metalens](https://arxiv.org/abs/2605.10532v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-11
- **作者**: Shiu Hei Lam, U Abinash Patro, Jan Rothhardt et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出EUV超透镜高效设计策略
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过改进布局与映射规则提升了EUV超透镜效率，方法实用且严谨。

## Spintronics

### 1. **[Laser-induced demagnetization in a MAX phase (Cr0.5Mn0.5)2GaC](https://arxiv.org/abs/2605.10483v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Iaroslav Mogunov, Artyom Gorshkov, Mikhail Rautskii et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示了MAX相材料的超快退磁动力学特性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 研究方法严谨，为MAX相在自旋电子学的应用提供了新视角。

## Condensed Matter Physics

### 1. **[Transverse Magnetic Response from Orbitally Polarized Cooper Pairs in Elemental Superconductors](https://arxiv.org/abs/2605.10700v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Gabor Csire, Maria Teresa Mercaldo, Balazs Ujfalussy et al.
- **标签**: `cond-mat.supr-con` `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示应变元素超导体中的轨道极化库珀对及其横向磁响应。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，为超导轨道电子学提供了新平台。

### 2. **[Micro-environment of the Eu interstitial in $β$-SiAlON:Eu$^{2+}$ green phosphor](https://arxiv.org/abs/2605.10665v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Julien Bouquiaux, Samuel Poncé, Yongchao Jia et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示β-SiAlON:Eu2+原子级微观结构与发光机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合第一性原理与蒙特卡洛模拟，理论解释与实验高度吻合。

### 3. **[Oxygen vacancies beyond the dilute limit in doped CaMnO3 perovskites and implications for screening materials in thermochemical applications](https://arxiv.org/abs/2605.10636v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Harender S. Dhattarwal, Colin M. Hylton-Farrington, Ian G. McKendry et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出钙钛矿氧空位筛选新框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 修正了筛选基准，方法严谨且具实际应用价值。

### 4. **[Rare-Earth-Tuned Evolution from d- to f-Orbital Dominance and Giant Anomalous Hall Effect in Topological RGaGe (R = Ce, Pr, Nd) Semimetals](https://arxiv.org/abs/2605.10509v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Zhian Xu, Jian Yuan, Ze Yan et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示RGaGe系列拓扑半金属的轨道演化与反常霍尔效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合实验与理论，系统阐述了磁性与拓扑态的关联，研究严谨且具有重要物理意义。

### 5. **[Optical selection rules in hexagonal Ge polytypes and their lifting by symmetry perturbation](https://arxiv.org/abs/2605.10709v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Martin Keller, Haichen Wang, Friedhelm Bechstedt et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示六方锗多型光学选择定则及对称性破缺调控机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨，通过对称性调控提升光学性能，具有应用价值。

## Theoretical Physics

### 1. **[Passive optical superresolution at the quantum limit](https://arxiv.org/abs/2605.10767v1)**
- **评分**: ⭐ 83/100 | **日期**: 2026-05-11
- **作者**: A. I. Lvovsky, Michael R. Grace, Saikat Guha et al.
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 综述了利用量子测量理论突破光学衍射极限的超分辨率成像技术。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该综述系统总结了量子受限成像的理论框架与实验进展，具有极高的学术参考价值。

### 2. **[Physical relevance of time-independent scattering predictions in periodic $\mathcal{PT}$-symmetric chains](https://arxiv.org/abs/2605.10657v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-11
- **作者**: Chao Zheng
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 揭示PT对称链散射预测的物理有效性边界
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 严谨推导了TGBS阈值，对非厄米物理具有重要指导意义

### 3. **[QT-Net: Rethinking Evaluation of AI Models in Atomic Chemical Space](https://arxiv.org/abs/2605.10458v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: Pablo Martínez Crespo, Stefano Ribes, Martin Rahm et al.
- **标签**: `cs.LG` `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 提出QT-Net模型及原子空间评估协议
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入了严谨的原子级分布外评估框架，方法论扎实且具有应用价值。

### 4. **[Algorithmic Advantage on a Gate-Based Photonic Quantum Neural Network](https://arxiv.org/abs/2605.10801v1)**
- **评分**: ⭐ 73/100 | **日期**: 2026-05-11
- **作者**: Solomon McKiernan, Luca Sapienza
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 实验验证了门控光子量子神经网络在分类任务中的算法优势。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 演示了光子QNN在极少参数下优于传统神经网络的分类性能。

### 5. **[Squeezing Enhancement Through Resonant Interference in Multi-ring Resonators](https://arxiv.org/abs/2605.10731v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-05-11
- **作者**: M. Sloan, J. E. Sipe
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 研究多环谐振器中利用共振干涉增强挤压光产生的方法。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 提出非微扰模型，通过杂化效应抑制寄生四波混频并补偿色散。
