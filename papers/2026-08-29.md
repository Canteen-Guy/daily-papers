...
### 1. **[Coupled anisotropic weak topological states and Floquet mixed-parity altermagnetism in two-dimensional Su-Schrieffer-Heeger models](https://arxiv.org/abs/2608.27329v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-08-27
- **作者**: Kunyuan Feng, Xibin Liu, Chenchen Liu et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出二维SSH模型中拓扑态与反铁磁序的耦合机制。
<details>
...
- **评分理由**: 通过Floquet工程实现了混合宇称反铁磁态，理论创新性较强。

## Topological Photonics

### 1. **[Ultra-Low-Loss Silicon Nitride on Sapphire for Broad-Transparency Nonlinear and Quantum Photonics](https://arxiv.org/abs/2608.27335v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Abdur-Raheem Al-Hallak, Shuai Liu, Kailu Zhou et al.
...
- **评分理由**: 实现了超低损耗与宽光谱覆盖，在非线性光子学领域有重要应用价值。

### 2. **[Self-starting Dynamics in All-fibre All-Normal-Dispersion Thulium Mamyshev oscillator](https://arxiv.org/abs/2608.27050v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Dennis C. Kirsch, Kirill Grebnev, Alberto Rodriguez Cuevas et al.
- **标签**: `physics.optics`
- **AI摘要**: 实现首个全光纤掺铥Mamyshev振荡器自启动
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 填补了长波红外超快激光自启动技术的空白，实验与模拟严谨。

## Spintronics

### 1. **[Emergent Skyrmion Hall Effect in $d$-wave Altermagnets at Finite Temperature](https://arxiv.org/abs/2608.27107v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Tingting Liu, Bingyu Sun, Fengyue Zhu et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示反铁磁体中热诱导各向异性斯格明子霍尔效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，揭示了对称性相关的热磁子输运机制

### 2. **[Laser induced ultrafast Co 3d and Ho 4f spin dynamics in CoHo ferrimagnetic alloys](https://arxiv.org/abs/2608.27083v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-27
- **作者**: Deeksha Gupta, Boonthum Kunyangyuen, Matthias Riepp et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示CoHo合金中Co与Ho亚晶格的超快自旋动力学差异。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，为全光磁翻转机制提供了关键实验证据。

## Condensed Matter Physics

### 1. **[Scalable, Simple, and Versatile Encapsulation of 2D Materials and Devices](https://arxiv.org/abs/2608.27383v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Gabriel Natale, Uma Chirkova, Flávio Henriques Feres et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci` `cond-mat.supr-con`
- **AI摘要**: 提出铝氧化物封装二维材料的新方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该方法简化了空气敏感材料的封装工艺，具有高实用性与严谨性。

### 2. **[Temperature dependence of the charge density from first principles: application to the (222) forbidden reflection in silicon](https://arxiv.org/abs/2608.27361v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Jean Paul Nery, Raveena Gupta, Olle Hellman et al.
- **标签**: `cond-mat.mtrl-sci` `physics.comp-ph`
- **AI摘要**: 通过第一性原理计算硅(222)禁戒反射的温度依赖性。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨，解决了禁戒反射理论中依赖经验修正的问题。

### 3. **[Grain Boundary Phase Transitions Enable Diffusionless Climb of Disconnections](https://arxiv.org/abs/2608.27314v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Md Sharier Nazim, Giacomo Po, Nikhil Chandra Admal
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示晶界相变驱动位错无扩散攀移机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过分子动力学揭示了晶界结构演化与位错攀移的耦合机制，具有理论创新性。

### 4. **[Crystal Structure Prototype Identification via Element-Mapped Rotation-Invariant Descriptors](https://arxiv.org/abs/2608.27262v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Pai Li
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出基于元素映射的晶体结构原型识别方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且高效，分类精度高，实用性强。

### 5. **[Terahertz anomalous Hall effect in magnetic Weyl semimetal Co$_3$Sn$_2$S$_2$](https://arxiv.org/abs/2608.27195v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Ashutosh Singh, Hongjing Xu, Xielin Wang et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 利用太赫兹光谱揭示了Co3Sn2S2的内禀手性光学响应。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实验与理论结合深入解析了外尔半金属的拓扑特性。

## Theoretical Physics

### 1. **[ElemCo.jl: A Julia package for electron-correlation methods](https://arxiv.org/abs/2608.27177v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-27
- **作者**: Daniel Kats, Charlotte Rickert, Thomas Schraivogel et al.
- **标签**: `physics.chem-ph` `cond-mat.mtrl-sci`
- **AI摘要**: ElemCo.jl电子关联计算软件包
<details>
<summary>原始摘要</summary>
