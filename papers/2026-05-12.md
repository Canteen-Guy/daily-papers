...
### 1. **[Dynamically Reconfigurable Optical Skyrmions Enabled by a Silicon Microring Optical Phased Array for Robust Free-Space Communication](https://arxiv.org/abs/2605.10283v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-11
- **作者**: Zili Cai, Tian Zhang, Qi Chen et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出硅基微环光相控阵，实现可重构光学斯格明子通信。
<details>
...
- **评分理由**: 芯片集成度高，动态重构能力强，在抗湍流自由空间通信中表现优异。

## Topological Photonics

### 1. **[Noise-like pulse laser source with ultrabroadband tunability and coherence-limited sub-structure](https://arxiv.org/abs/2605.09816v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-10
- **作者**: Xinyang Liu, Matias Koivurova, Regina Gumenyuk
- **标签**: `physics.optics`
- **AI摘要**: 提出一种具有宽带可调谐性的噪声脉冲激光源。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，有效解决了高亮度与低相干性的平衡问题。

## Spintronics

### 1. **[A Single-Molecule Spin-Photon Interface](https://arxiv.org/abs/2605.10077v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-11
- **作者**: Simon Roggors, Thomas Unden, Anna Aubele et al.
- **标签**: `quant-ph` `cond-mat.mtrl-sci`
- **AI摘要**: 首次实现具有单分子可寻址性和长相干时间的分子自旋光子接口。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 突破分子体系在量子接口方面的性能瓶颈，展示了自下而上化学设计的优势。

### 2. **[Valley-contrasting Spin Textures in Janus Metal Phosphochalcogenides](https://arxiv.org/abs/2605.10011v1)**
- **评分**: ⭐ 72/100 | **日期**: 2026-05-11
- **作者**: Zeyu Yin, Li Liang, Zhichao Zhou et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 研究Janus金属磷硫族化合物中随能谷变化的自旋织构。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过第一性原理计算揭示了Janus结构中多种自旋织构的共存与调控。

## Condensed Matter Physics

### 1. **[A molecular perspective on coordination, screening, and emergent length scales in lithium electrolytes](https://arxiv.org/abs/2605.10089v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-11
- **作者**: A. Coste, E. Zunzunegui-Bru, A. van Roekeghem et al.
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci`
- **AI摘要**: 提出锂电解质中配位、屏蔽与输运耦合的统一多尺度框架。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统整合了从分子到宏观的电解质物理图景，对高浓度体系设计具有重要指导意义。

### 2. **[Parabolic-growth universality and its nucleation-driven breakdown across lithium-battery anode chemistries](https://arxiv.org/abs/2605.10217v1)**
- **评分**: ⭐ 77/100 | **日期**: 2026-05-11
- **作者**: Changdeuck Bae
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示锂电池界面生长的普适抛物线规律及其在无负极体系的失效
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 跨体系验证了SEI生长的动力学标度律，为电池寿命预测提供了物理基础。

### 3. **[Time-of-flight force sensing below the quantum zero-point fluctuation](https://arxiv.org/abs/2605.09854v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-11
- **作者**: Sotatsu Otabe, Mitsuyoshi Kamba, Yuto Kojima et al.
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 利用悬浮纳米振子通过势阱调制实现亚零点涨落力传感。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验展示了突破零点涨落的力传感，结合量子态层析成像，方法严谨且具有创新性。

### 4. **[Orbital and Spin Nernst Effects in Monolayers of Transition Metal Dichalcogenides](https://arxiv.org/abs/2605.10033v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-11
- **作者**: Saikat Saha, Arnab Bose, Sayantika Bhowal
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 研究单层过渡金属硫化物中的轨道与自旋能斯特效应。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合解析模型与紧束缚计算，揭示了轨道贝里曲率在热电输运中的核心作用。

### 5. **[Families of planar lattices with arbitrarily high $T_{\rm c}$ for the ferromagnetic Ising model](https://arxiv.org/abs/2605.10017v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-11
- **作者**: Davidson Noby Joseph, Connor M. Walsh, Igor Boettcher
- **标签**: `cond-mat.stat-mech` `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 构造了具有任意高临界温度的平面晶格族并推导其标度律。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，通过迭代三角化构造晶格，揭示了临界温度与配位数关系。

## Theoretical Physics

### 1. **[Thermal Deformation Reduction in High-Power Interferometry with Higher-Order Laser Modes](https://arxiv.org/abs/2605.10222v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-11
- **作者**: Liu Tao, Yuhang Zhao, Zong-Hong Zhu et al.
- **标签**: `astro-ph.IM` `physics.optics`
- **AI摘要**: 证明高阶激光模式能有效减少引力波探测器中的热变形。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 量化了高阶模式对热畸变的抑制作用，对未来高功率干涉仪设计具有重要参考价值。

### 2. **[Measurement-Adapted Eigentask Representations for Photon-Limited Optical Readout](https://arxiv.org/abs/2605.10008v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-05-11
- **作者**: Tianyang Chen, Mandar M. Sohoni, Saeed A. Khan et al.
- **标签**: `physics.optics` `cs.CV` `cs.ET`
- **AI摘要**: 提出特征任务表示法，优化光子受限环境下的光学成像推理。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 针对低光照成像提出新表征方法，实验证明其在少样本分类中优于基准。
