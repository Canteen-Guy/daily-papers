...
- **AI摘要**: 提出PIAA-ZWFS波前传感器，显著提升高对比度成像灵敏度。
<details>
...
- **评分理由**: 方法创新且性能接近理论极限，数学推导严谨，应用价值高。

### 2. **[Quantum frequency comb with pump-selectable bin pairing and extraction-aware loading in a lithium niobate microresonator](https://arxiv.org/abs/2606.27911v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-26
- **作者**: Mohamad Reza Nurrahman, Hyeon Hwang, Nuri Han et al.
- **标签**: `physics.optics`
- **AI摘要**: 铌酸锂微腔量子频率梳源
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 展示了高亮度与可调谐的量子光源，实验严谨且应用前景广阔。

### 3. **[Unidirectional Guided Resonances Enabled by Competing Fourier Harmonics near the Fourth Stop Band](https://arxiv.org/abs/2606.27920v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-26
- **作者**: Sun-Goo Lee, Wook-Jae Lee
- **标签**: `physics.optics`
- **AI摘要**: 提出基于傅里叶谐波竞争的单向导模共振新机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 机制新颖且简化了设计，理论严谨，逻辑清晰。

## Metamaterials

### 1. **[Physics-constrained neural networks for surrogate modeling of lossless periodic structures](https://arxiv.org/abs/2606.28119v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-26
- **作者**: Eric Prehn, Peter Jung
- **标签**: `physics.optics` `cs.LG`
- **AI摘要**: 提出物理约束神经网络以加速周期结构建模
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过流形投影实现能量守恒，在逆向设计中表现优异。

### 2. **[Broadband on-chip Half Maxwell Fisheye](https://arxiv.org/abs/2606.28038v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-26
- **作者**: Xin Zheng, Quan Yue, Jean-René Coudevylle et al.
- **标签**: `physics.optics`
- **AI摘要**: 硅基光子芯片半麦克斯韦鱼眼透镜设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合仿真与实验验证，设计新颖且性能优异。

## Spintronics

### 1. **[Room-temperature magnon-phonon transduction in high-damping Co/Pt structures](https://arxiv.org/abs/2606.28073v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-26
- **作者**: Gauravkumar Patel, Takuma Sato, Maximilian Frenzel et al.
...
- **评分理由**: 通过Co/Pt异质结实现磁子声子耦合，实验与理论结合紧密。

## Condensed Matter Physics

### 1. **[Symmetry-Selective Strain Control of Spin-Momentum Locking and Spin Transport in Two-Dimensional Pentagonal Altermagnets](https://arxiv.org/abs/2606.27896v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-26
- **作者**: ShuaiYu Wang, Sheng Chen, Xiao-Ping Li et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出应变调控二维五角反铁磁自旋输运的对称性框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对称性分析与高通量筛选，系统揭示了应变对反铁磁自旋锁定的调控机制。
...
- **评分**: ⭐ 88/100 | **日期**: 2026-06-26
- **作者**: Yangyang Si, Denan Li, Yijie Li et al.
- **标签**: `cond-mat.mtrl-sci` `physics.app-ph`
- **AI摘要**: 构建偶极玻璃实现极低温高效储能
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性设计偶极玻璃态，性能指标突破且实验严谨。

### 3. **[Moiré Phonons and Emergent Exciton-Phonon Coupling in a Moiré Heterobilayer](https://arxiv.org/abs/2606.28185v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-26
- **作者**: Can B. Uzundal, Woochang Kim, Zhiyuan Cui et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 揭示了莫尔超晶格中声子与激子的层选择性耦合机制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合太赫兹光谱与第一性原理计算，研究深入且严谨。

### 4. **[Direct Observation of X-ray Double-Slit Interference in Momentum Space](https://arxiv.org/abs/2606.28176v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-26
- **作者**: Fugui Yang, Xiaoxiao Liang, Tianchong Zhang et al.
...
- **评分理由**: 创新性地去除了传播距离限制，实验严谨且具有高实用价值。

### 5. **[Hidden valley dynamics behind vanishing circular polarization in moiré excitons](https://arxiv.org/abs/2606.27963v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-26
- **作者**: Yuto Urano, Lata Chouhan, Nurul Fariha Ahmad et al.
...
- **评分理由**: 通过时间分辨光谱揭示了谷极化消失的动力学本质，方法严谨。

## Theoretical Physics

### 1. **[Vacuum Fluctuation-Induced State Switching in Degenerate Optical Parametric Oscillators](https://arxiv.org/abs/2606.28178v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-26
- **作者**: Yihao Huang, Seou Choi, Rom Simovitch et al.
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 揭示真空涨落诱导OPO态切换机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且具应用潜力，对量子噪声调控有重要意义。

### 2. **[Detector-Conditioned Source-Space Nulls and Null-Mask Loss in a Programmable Two-Slit Interferometer](https://arxiv.org/abs/2606.27817v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-06-26
- **作者**: Jianming Wen
- **标签**: `quant-ph` `physics.optics`
- **AI摘要**: 提出时间反演Afshar实验的源空间零点检测模型
<details>
<summary>原始摘要</summary>
