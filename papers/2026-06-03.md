...
### 1. **[Skyrmions in scalar fields of non-Hermitian optical microcavities: spontaneous formation, nonlinear control, and optical forces](https://arxiv.org/abs/2606.02265v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Jan Wingenbach, Roman Lebs, Xuekai Ma et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出非厄米微腔中标量场斯格明子生成与调控机制
<details>
...
- **评分理由**: 理论创新性强，为拓扑光子学提供了新颖的调控手段。

## Topological Photonics

### 1. **[Multilayer Babinet metamaterial to initiate nonreciprocal topological phenomena and generalized Faraday rotation](https://arxiv.org/abs/2606.02571v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-01
- **作者**: Balázs Bánhelyi, Miklós Waldhauser, Virág Szünstein et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用Babinet超材料实现非互易拓扑光子学效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结构设计新颖且物理机制深入，但实验验证部分略显不足。

### 2. **[Practical Limits on Integrated Squeezers](https://arxiv.org/abs/2606.02524v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-01
- **作者**: Devin J. Dean, Taewon Park, Lars S. Madsen et al.
...
- **评分理由**: 研究系统性分析了集成压缩光噪声瓶颈，具有实用指导意义。

### 3. **[Perturbative photonic matrix-vector multiplication with reduced phase-shift range](https://arxiv.org/abs/2606.02451v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-06-01
- **作者**: S. A. Fldzhyan, S. S. Straupe, M. Yu. Saygin
- **标签**: `physics.optics`
- **AI摘要**: 提出微扰编程法以缩减光子矩阵计算的相位范围
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且逻辑严密，有效解决了光子芯片扩展性瓶颈

## Spintronics

### 1. **[Room-Temperature Electric-Field Control of Anomalous Hall Effect in Py/BTO/LSMO Heterostructures](https://arxiv.org/abs/2606.02298v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Kusampal Yadav, Kousik Das, Aditya Raj et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 实现室温下电场调控反常霍尔效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，电场调控机制具有显著应用潜力

## Condensed Matter Physics

### 1. **[Symmetry-Protected Weyl Nodal Loops in a Triangular Altermagnet](https://arxiv.org/abs/2606.02527v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Chao-Chun Wei, Xiaoyin Li, Sophia Adams et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 发现Cr7Se8中对称性保护的Weyl节线反铁磁态
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合中子衍射与第一性原理，实验证实了新型反铁磁拓扑态

### 2. **[DPA4: Pushing the Accuracy-Cost Frontier of Interatomic Potentials with EMFA SO(2) Convolution](https://arxiv.org/abs/2606.02419v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Tiancheng Li, Wentao Li, Anyang Peng et al.
- **标签**: `physics.chem-ph` `cond-mat.mtrl-sci` `physics.comp-ph`
- **AI摘要**: 提出DPA4架构，实现原子势能高精度低成本计算。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在计算效率与精度上取得显著突破，实验验证充分。

### 3. **[Sub-cycle field-driven dynamical Berry phase in solids](https://arxiv.org/abs/2606.02238v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-06-01
- **作者**: Lior Faeyrman, Jianing Zhang, Misha Ivanov et al.
- **标签**: `cond-mat.mtrl-sci` `physics.optics`
- **AI摘要**: 利用强THz场诱导MgO产生动态Berry相位
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验突破了对称性限制，成功观测并重构了动态Berry相位。

### 4. **[A Mid-Infrared Platform Based on Strontium Tweezer Arrays](https://arxiv.org/abs/2606.02560v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Aaron Holman, Ximo Sun, Bojeong Seo et al.
- **标签**: `physics.atom-ph` `cond-mat.quant-gas` `physics.app-ph`
- **AI摘要**: 实现锶原子中红外光镊阵列及高保真操控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入中红外跃迁，实验严谨且应用前景广阔

### 5. **[Towards Automated Discovery: A Review of Generative Models, Multimodal Learning and Closed-Loop Workflows in Inverse Materials Design](https://arxiv.org/abs/2606.02507v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Anand Babu, Rogério Almeida Gouvêa, Gian-Marco Rignanese
- **标签**: `cond-mat.mtrl-sci` `cs.ET` `cs.LG`
- **AI摘要**: 综述材料逆向设计中的生成模型与闭环工作流进展
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统梳理了材料发现领域的前沿方法，逻辑严密且具有高实用价值。

## Theoretical Physics

### 1. **[Speculative Sampling For Faster Molecular Dynamics](https://arxiv.org/abs/2606.02455v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Arthur Kosmala, Stephan Günnemann, Meng Gao et al.
- **标签**: `cs.LG` `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 提出LSD算法加速分子动力学模拟
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 引入投机采样提升MD效率，理论与实验支撑扎实。

### 2. **[Neural Spectral Element Methods for stiff multiphysics PDEs with electrochemical transport benchmarks](https://arxiv.org/abs/2606.02335v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-06-01
- **作者**: Conrard Giresse Tetsassi Feugmo, David Pankaczy
- **标签**: `cond-mat.mtrl-sci` `math-ph` `physics.app-ph`
- **AI摘要**: 提出NSEM方法高效求解电化学偏微分方程。
<details>
<summary>原始摘要</summary>
