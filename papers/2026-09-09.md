...
### 1. **[Generalized Helicity-Dependent Magnetization Switching via Substrate Phonons](https://arxiv.org/abs/2609.05064v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-04
- **作者**: F. G. N. Fennema, H. Damas, H. Yoshikawa et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示了衬底声子驱动磁化翻转的普适性与光学机制。
<details>
...
- **评分理由**: 实验设计严谨，系统性地验证了声子介导翻转的普适性。

### 2. **[Interfacial Accommodation as a Candidate Ductility Pathway in Intermetallic-Rich Alloys](https://arxiv.org/abs/2609.05147v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Avik Mahata
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出量化界面应变调节的原子模拟框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且严谨，为金属材料设计提供了新视角

### 3. **[Semiclassical thermoelectric transport in disordered Dirac electron system Ag2Te](https://arxiv.org/abs/2609.05130v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Kentaro Kuga, Keisuke Hirata, Daiki Goto et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示Ag2Te中无序狄拉克电子的热电输运机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过半经典模型解释了磁场下的异常热电效应，方法严谨且具有参考价值。

### 4. **[Anharmonic Lattice Dynamics and Anisotropic Electron-Phonon Coupling in Quasi-1-Dimensional Charge Density Wave Ta2NiSe7](https://arxiv.org/abs/2609.05129v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Prithwija Mandal, S. Nanthini, Aditya Singh et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示Ta2NiSe7中电声耦合与晶格非谐性的协同作用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验与理论结合深入，系统阐明了CDW形成的各向异性机制。

### 5. **[Influence of dislocation density on the tribological response in oxides: case study on SrTiO3](https://arxiv.org/abs/2609.05056v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-04
- **作者**: Chukwudalu Okafor, Oliver Preuß, Thomas Chudoba et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示位错密度对SrTiO3摩擦损伤的调控机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实验与模型验证了位错对陶瓷表面损伤的抑制作用，方法严谨。
