...
### 1. **[Visualization of Defect Electronic States in Layered Semiconductor CrSBr](https://arxiv.org/abs/2607.21301v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Jonathan Brunette, Joost Aretz, Kiyoung Jo et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 利用STM揭示CrSBr中硫空位缺陷的电子态结构
<details>
...
- **评分理由**: 结合STM实验与第一性原理计算，深入解析了材料缺陷特性。

### 2. **[Lifetime effects and satellites in the photoelectron spectrum of platinum metal](https://arxiv.org/abs/2607.21298v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Prajna Bhatt, José Julio Gutiérrez Moreno, Laura E. Ratcliff et al.
- **标签**: `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 揭示铂金属光电子能谱的精细结构与多体效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验与理论结合紧密，为铂基材料研究提供基准

### 3. **[Thermal Hall Resistivity as a Unifying Description of Phonon Thermal Hall Effect in Various Insulators](https://arxiv.org/abs/2607.21157v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Dirui Wu, Ying Kit Tsui, Xavier Loh et al.
...
- **评分理由**: 通过实验证实了热霍尔电阻率在绝缘体中的普适性

### 4. **[Matrix-free phase-field modeling of fracture in micromechanical testing simulations of inelastic materials](https://arxiv.org/abs/2607.21150v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-07-23
- **作者**: Fabio Di Gioacchino, Rezgar Shakeri, Zachary Atkins et al.
...
- **评分理由**: 高效实现高阶有限元断裂模拟，计算性能优异

### 5. **[Magneto-Caloric effect and Multiple magnetic phases in Al doped Ni2MnSn0.75Al0.25 Heusler Alloys](https://arxiv.org/abs/2607.21181v1)**
- **评分**: ⭐ 74/100 | **日期**: 2026-07-23
- **作者**: Satya Vijay Kumar, Simran, Madhusmita Jena et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.str-el`
- **AI摘要**: 研究了Al掺杂Ni2MnSn合金的磁热效应与磁相变
<details>
<summary>原始摘要</summary>
