...
### 1. **[Nonlocality is the missing design rule for topological photonics](https://arxiv.org/abs/2608.23360v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Fatemeh Davoodi
- **标签**: `physics.optics` `quant-ph`
- **AI摘要**: 提出将非局域性作为拓扑光子学设计参数的新范式。
<details>
...
- **评分理由**: 视角独特，将非局域性从干扰转为设计工具，具有高实用价值。

### 2. **[Diffractive optical element for super-Gaussian beam shaping on intersatellite optical communications](https://arxiv.org/abs/2608.23532v1)**
- **评分**: ⭐ 70/100 | **日期**: 2026-08-24
- **作者**: Mario Badás Aldecocea, Ziheng Wang, Mohammad Dabiri et al.
- **标签**: `physics.optics`
- **AI摘要**: 利用衍射元件优化星间光通信光束整形
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法实用且分析全面，但在创新性上属于常规工程优化。

## Spintronics

### 1. **[Mapping metallic d-wave altermagnetism across the TiNiSi structural family](https://arxiv.org/abs/2608.23409v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Zhen Zhang, Subhadip Pradhan, Kirill D. Belashchenko et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 发现TiNiSi族金属d波反铁磁体
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过高通量筛选发现新型反铁磁材料，方法严谨且具有应用潜力。

## Condensed Matter Physics

### 1. **[Giant Surface-driven Nonlinear Hall Effect in BiTeCl at Room Temperature](https://arxiv.org/abs/2608.23368v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-24
- **作者**: Zhihua Liu, Ziheng Wang, Yongbo Lv et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: BiTeCl中室温巨非线性霍尔效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验发现室温下巨非线性霍尔响应，具有极高应用潜力。

### 2. **[Large Jahn-Teller shifts and splittings observed in halide perovskite CsPbBr3](https://arxiv.org/abs/2608.23510v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Maryam Sajedi, Maxim Krivenkov, Dmitry Marchenko et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示CsPbBr3中姜-泰勒效应及其电子结构影响
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验观测与理论计算结合紧密，对理解钙钛矿物理机制贡献显著。

### 3. **[One micron length scale controls kinetic stability of low energy glasses](https://arxiv.org/abs/2608.23454v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Kenneth L. Kearns, M. D. Ediger, Heiko Huth et al.
- **标签**: `cond-mat.soft` `cond-mat.mtrl-sci`
- **AI摘要**: 发现1微米尺度控制低能玻璃动力学稳定性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，揭示了玻璃态转变的尺度效应，具有较高的物理洞察力。

### 4. **[Resistive Switching and Neuromorphic Computing in Metal/Nb:SrTiO$_3$: Mechanisms, Interface Physics, and Charge Transport](https://arxiv.org/abs/2608.23430v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Christopher Broyles, Elizabeth Krenkel, Frank Barrows et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 综述Nb:STO忆阻器界面物理与阻变机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统梳理了界面缺陷与阻变机制，对器件设计有指导意义

### 5. **[Absence of lateral domain wall mobility in Zn1-xMgxO thin films](https://arxiv.org/abs/2608.23305v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-08-24
- **作者**: Jack Eckstein, Kyle P. Kelley, William Prudnick et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 揭示ZnMgO铁电薄膜的成核主导翻转机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过扫描探针显微技术揭示了独特的畴壁动力学，研究严谨且具有重要物理意义。

## Theoretical Physics

### 1. **[Tracking molecular hydrogen formation from ionized water in real time](https://arxiv.org/abs/2608.23292v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-08-24
- **作者**: Chuan Cheng, Chi-Hong Yuen, Eleanor Weckwerth et al.
...
- **评分理由**: 结合超快光谱与模拟揭示了水分子产氢的动力学机制

### 2. **[Beyond chlorophyll: machine learning estimates of diagnostic phytoplankton pigments from multispectral ocean colour data](https://arxiv.org/abs/2608.23348v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-08-24
- **作者**: David Moffat, Angus Laurenson, Victor Martinez-Vicente et al.
- **标签**: `q-bio.OT` `cs.LG` `physics.optics`
- **AI摘要**: 利用机器学习从多光谱数据反演浮游植物色素
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法严谨且具有实际应用价值，但在物理学领域相关性较低。
