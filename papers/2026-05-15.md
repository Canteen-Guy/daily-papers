...
### 1. **[Integrated ytterbium gain for visible-near-infrared photonics](https://arxiv.org/abs/2605.13828v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-13
- **作者**: Tianyi Zeng, Erik W. Masselink, Tsung-Han Wu et al.
- **标签**: `physics.optics`
- **AI摘要**: 实现铝氧化物平台镱离子集成光增益与高功率放大
<details>
...
- **评分理由**: 性能指标卓越，在集成光子学领域具有重大突破。

### 2. **[Giant optical spin-orbit interactions in ferroelectric van der Waals waveguides](https://arxiv.org/abs/2605.13707v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-13
- **作者**: Ding Xu, Saeed Rahmanian Koshkaki, Vicente Galicia et al.
- **标签**: `cond-mat.mtrl-sci` `physics.optics`
- **AI摘要**: 利用范德华波导实现巨型光学自旋轨道耦合
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该研究在集成光子学领域具有显著创新与应用潜力

### 3. **[Storage of telecom-band time-bin qubits in thin-film lithium niobate](https://arxiv.org/abs/2605.13545v1)**
- **评分**: ⭐ 84/100 | **日期**: 2026-05-13
- **作者**: Xiao-Jie Wang, Yong-Teng Wang, Zi-Wei Zhao et al.
...
- **评分理由**: 首次在TFLN实现量子存储，性能优异且应用前景广阔。

### 4. **[DeepFilters: Scattering-Aware Pupil Engineering with Learned Digital Filter Reconstruction for Extended Depth of Field Microscopy](https://arxiv.org/abs/2605.13619v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-13
- **作者**: Joseph L. Greene, Suet YIng Chan, Qilin Deng et al.
...
- **评分理由**: 结合物理模型与深度学习，有效提升散射介质成像深度

### 5. **[Ghost State of Light](https://arxiv.org/abs/2605.13584v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-13
- **作者**: R. M. de Boer, C. Toebes, Jan Klars et al.
- **标签**: `physics.optics` `cond-mat.mes-hall` `cond-mat.stat-mech`
- **AI摘要**: 观测到光腔中长寿命非稳态鬼态
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过非线性记忆效应实现长寿命鬼态，实验严谨且具创新性

## Metamaterials

### 1. **[HADAR-Based Thermal Infrared Hyperspectral Image Restoration](https://arxiv.org/abs/2605.13664v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-13
- **作者**: Cheng Dai, Jiale Lin, Bingxuan Song et al.
- **标签**: `cs.CV` `physics.optics`
- **AI摘要**: 提出基于HADAR的物理驱动热红外高光谱图像恢复框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合物理模型与深度学习，在热红外图像恢复领域有显著创新。

## Spintronics

### 1. **[Chiral molecule-induced contributions to ferromagnetic resonance](https://arxiv.org/abs/2605.13805v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: Jurgen Lindner, Pedro Contreras-Gallardo, Abhishek Singh et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示手性分子对铁磁共振动力学的影响机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过宏自旋模型区分了平衡态能垒与非平衡自旋扭矩

### 2. **[Magnetization-dependent and stacking-tunable Edelstein effect in two-dimensional magnet 2H-VTe2](https://arxiv.org/abs/2605.13763v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: Weiyi Pan, Jaroslav Fabian
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 揭示2H-VTe2中磁化与堆叠调控的Edelstein效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论分析严谨，通过对称性与第一性原理揭示了自旋调控机制。

## Condensed Matter Physics

### 1. **[Anisotropic Dopant and Strain Architectures in WS$_2$ Nanocrystals Driven by Growth Kinetics](https://arxiv.org/abs/2605.13577v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-13
- **作者**: Frederico B. Sousa, Raphaela de Oliveira, Matheus J. S. Matos et al.
- **标签**: `cond-mat.mtrl-sci` `physics.optics`
- **AI摘要**: 利用动力学实现二维材料掺杂与应变调控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过非平衡生长动力学实现确定性缺陷工程，方法创新且论证严谨。

### 2. **[Correlation-driven tunability of altermagnetism in RuO$_2$](https://arxiv.org/abs/2605.13559v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-13
- **作者**: Ina Park, Dongwook Kim, Jisook Hong et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.str-el`
- **AI摘要**: 揭示RuO2电子关联性与磁性相变机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用DFT+DMFT方法深入解析了RuO2磁性不确定性，理论严谨且具有重要应用价值。

### 3. **[Nonlinear dynamic elastic moduli from equilibrium stress fluctuations](https://arxiv.org/abs/2605.13703v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: F. E. Garbuzov, Y. M. Beltukov
- **标签**: `cond-mat.mtrl-sci` `cond-mat.stat-mech`
- **AI摘要**: 推导非线性动态模量涨落公式
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论推导严谨，填补了非线性粘弹性响应计算的空白。

### 4. **[OpenAaaS: An Open Agent-as-a-Service Framework for Distributed Materials-Informatics Research](https://arxiv.org/abs/2605.13618v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: Peng Kang, Bixuan Li, Xiaoya Huang et al.
- **标签**: `cond-mat.mtrl-sci` `cs.AI`
- **AI摘要**: 提出OpenAaaS分布式智能体框架以实现材料数据安全协作
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 架构创新且具备实际应用价值，实验验证充分，逻辑清晰。

### 5. **[Assessing foundational atomistic models for iron alloys under Earth's core conditions](https://arxiv.org/abs/2605.13594v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: Tianqi Wan, Liangrui Wei, Zepeng Wu et al.
- **标签**: `physics.geo-ph` `cond-mat.mtrl-sci`
- **AI摘要**: 评估基础原子模型在地球核心条件下的适用性
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 系统评估了AI模型在极端条件下的性能与局限

## Theoretical Physics

### 1. **[Reducing cross-sample prediction churn in scientific machine learning](https://arxiv.org/abs/2605.13826v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-13
- **作者**: Gordan Prastalo, Kevin Maik Jablonka
- **标签**: `cs.LG` `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 提出双重自助法降低科学机器学习预测波动
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性地量化并解决了预测不稳定性问题，方法严谨且实用。

### 2. **[Amplitude Noise Suppression in Frequency-Doubled Lasers: A Lyapunov Mechanism for Intensity Stabilization in Coupled Oscillator Systems](https://arxiv.org/abs/2605.13745v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: Thomas M. Baer
- **标签**: `physics.optics`
- **AI摘要**: 利用李雅普诺夫机制抑制激光振幅噪声
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新且实验验证充分，具有较好的实用价值

### 3. **[Floquet engineering of nonreciprocal light-induced dipolar interactions](https://arxiv.org/abs/2605.13694v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: Livia Egyed, Murad Abuzarli, Manuel Reisenbauer et al.
- **标签**: `quant-ph` `physics.atom-ph` `physics.optics`
- **AI摘要**: 提出Floquet工程实现非互易光偶极相互作用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过Floquet驱动实现量子力学操控，具有前沿理论价值。

### 4. **[Adaptive time-domain simulation of optical cavities with arbitrary dynamics](https://arxiv.org/abs/2605.13599v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-13
- **作者**: A. Svizzeretto, J. Casanueva Diaz, B. L. Swinkels et al.
- **标签**: `physics.optics` `physics.ins-det`
- **AI摘要**: 提出一种高效的光学腔时域模拟方法
<details>
<summary>原始摘要</summary>
