...
### 1. **[Quantum-Secure Physical Unclonable Function enabled by Silicon Photonics Integrated Circuits](https://arxiv.org/abs/2605.14959v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: G. Sarantoglou, N. Tzekas, G. Moustakas et al.
...
- **评分理由**: 结合量子协议与光子集成电路，性能卓越且创新性强。

## Metamaterials

### 1. **[Multifunctional Barophotonic Control of Resonators and Metasurfaces](https://arxiv.org/abs/2605.15065v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Ping-Chun Chen, Mashnoon Alam Sakib, Mariia Stepanova et al.
- **标签**: `physics.optics` `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 提出压力调控氮化硅纳米光子器件新方法
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入静水压调控光子学，实验严谨且应用广泛。

### 2. **[Hybrid Nanophotonic Scintillators for Enhanced X-ray Absorption, Emission, and Time Resolution](https://arxiv.org/abs/2605.14992v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Seou Choi, Sachin Vaidya, Avner Shultzman et al.
- **标签**: `physics.optics` `cond-mat.mes-hall`
- **AI摘要**: 提出一维光子晶体闪烁体以提升X射线探测效率与时间分辨率。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过纳米结构设计同时优化能量转换与发射速率，具有显著应用潜力。

### 3. **[Single-Device VOC Fingerprinting via Polarization-Selective Anisotropic BeS-Clad Silicon Microring Resonator](https://arxiv.org/abs/2605.15139v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Sudipta Saha, Shoumik Debnath, Md Kawsar Alam
- **标签**: `physics.optics`
- **AI摘要**: 利用BeS包层硅微环实现VOC双偏振指纹检测
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新利用各向异性实现单器件多指标传感，方法严谨。

## Condensed Matter Physics

### 1. **[Programmable cavity-enhanced telecom quantum memory in thin-film lithium niobate](https://arxiv.org/abs/2605.14777v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-05-14
- **作者**: Chengdong Yang, Hanwen Guo, Yu-Yang An et al.
...
- **评分理由**: 在量子网络存储效率与可编程性上取得重要突破

### 2. **[Mid-infrared Assisted THz Phonon Amplification in a 2D Semiconductor for Room Temperature Detection](https://arxiv.org/abs/2605.15123v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Christopher Sumner, Jakob Ziewer, Anju Sajan et al.
- **标签**: `physics.app-ph` `cond-mat.mes-hall` `physics.optics`
- **AI摘要**: 提出MIRAPA技术实现室温声子放大
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性强，实验严谨，在声子探测领域具有应用潜力

### 3. **[Generative reconstruction of 2D and 3D polycrystalline microstructures using symmetrized hyperspherical harmonics](https://arxiv.org/abs/2605.14898v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Ali R. Safi, Paul Seibert, Santiago Benito et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 提出对称超球谐函数重构多晶微观结构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，通过数学优化提升了重构精度

### 4. **[Superconducting single-photon detectors for integrated quantum photonics](https://arxiv.org/abs/2605.14829v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Ilya A. Stepanov, Oksana I. Shmonina, Evgeniy V. Sergeev et al.
- **标签**: `physics.optics` `quant-ph`
- **AI摘要**: 综述集成超导纳米线单光子探测器的技术进展与应用。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该综述系统梳理了集成探测器的发展，具有高学术价值。

### 5. **[Atomically resolved intrinsic superconducting gap in (La,Pr)3Ni2O7 films](https://arxiv.org/abs/2605.14806v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-05-14
- **作者**: Xinxin Wang, Yaqi Chen, Cui Ding et al.
...
- **评分理由**: 利用STM技术观测到镍氧化物本征超导能隙，实验严谨。

## Theoretical Physics

### 1. **[Fast contracted Clebsch--Gordan tensor products for equivariant graph neural networks](https://arxiv.org/abs/2605.15073v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-05-14
- **作者**: Anton Bochkarev, Yury Lysogorskiy, Ralf Drautz
- **标签**: `physics.comp-ph` `cond-mat.mtrl-sci` `physics.chem-ph`
- **AI摘要**: 提出O(L^3)算法加速等变图神经网络张量积计算
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法优化显著提升了等变图神经网络的计算效率

### 2. **[Stokes-anti-Stokes correlations of light propagating through weakly guiding optical fiber](https://arxiv.org/abs/2605.14825v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-05-14
- **作者**: Ivan V. Panyukov, Evgeny S. Andrianov
- **标签**: `physics.optics`
- **AI摘要**: 揭示多模光纤中斯托克斯光相关性衰减机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 模型定量解释了光纤模式对非经典相关性的抑制作用

### 3. **[The influence of strong coupling between single-photon source and spectral filter on photon statistics](https://arxiv.org/abs/2605.14807v1)**
...
- **评分理由**: 模型有效简化了强耦合下的光子统计分析，具有理论价值。
