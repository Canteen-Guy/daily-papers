...
### 1. **[Topological Lithography via External Field: Creating Topological States Anywhere Beyond the Edge](https://arxiv.org/abs/2609.02670v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Haoran Nie, Chaoran Jiang, Xiangying Shen et al.
- **标签**: `cond-mat.other` `physics.app-ph`
- **AI摘要**: 提出外场诱导拓扑态的拓扑光刻技术
<details>
...
- **评分理由**: 创新性强，理论与多平台验证严谨，应用潜力大

### 2. **[Dynamical stabilisation of a quantum fluid using a single topological defect](https://arxiv.org/abs/2609.02643v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Deborah Capecchi, Paolo Comaron, Antonio Gianfrate et al.
- **标签**: `cond-mat.quant-gas` `physics.optics`
- **AI摘要**: 利用拓扑缺陷稳定量子流体坍缩
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验展示了拓扑电荷对量子流体坍缩的抑制，具有重要物理意义。

## Topological Photonics

### 1. **[Exponential speedup of polarization stabilization for long distance DWDM quantum networks](https://arxiv.org/abs/2609.02841v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Jinyi Du, En Teng Lim, Xingjian Zhang et al.
- **标签**: `quant-ph` `physics.app-ph` `physics.optics`
- **AI摘要**: 提出波长分段反馈实现量子网络偏振稳定
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性解决长距离量子网络偏振漂移，实验严谨

### 2. **[Optical Reservoir Computing with Structural Nonlinearity for Forecasting Chaotic Time Series](https://arxiv.org/abs/2609.02733v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Leandro R. Venâncio, Jonathan Dong, Mickael Mounaix et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出结构非线性光子储备池计算新架构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过线性组件实现非线性映射，实验验证有效

### 3. **[Random-mapped intensity optical neural network: all-optical two-layer computing for multimodal optical-field inference](https://arxiv.org/abs/2609.02698v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Gi-Hyun Go, Doeon Lee, Gookho Song et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出随机映射强度光神经网络以突破秩一限制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过无序介质实现多模态光场推理，方法创新且实验验证充分。

### 4. **[Exceptional Topological Signatures of Non-Hermitian Photonic Hopf-Link Braids](https://arxiv.org/abs/2609.02589v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-02
- **作者**: Samit Kumar Gupta
- **标签**: `physics.optics` `cond-mat.mes-hall` `quant-ph`
- **AI摘要**: 揭示非厄米光子霍普夫链辫的拓扑相变机制。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，分析严谨，对拓扑光子学有重要意义。

## Spintronics

### 1. **[Spin Hall Magnetoresistance in Antiferromagnetic Insulators](https://arxiv.org/abs/2609.02632v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-02
- **作者**: Stephan Geprägs, Matthias Opel, Johanna Fischer et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.mes-hall`
- **AI摘要**: 利用SMR探测反铁磁绝缘体自旋结构
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，展示了反铁磁自旋电子学的应用潜力。

### 2. **[Nonreciprocal Magnon Hanle Effect in Antiferromagnetic $α$-Fe$_2$O$_3$](https://arxiv.org/abs/2609.02631v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Janine Gückelhorn, Sebastián de-la-Peña, Monika Scheufele et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 观测到反铁磁材料中的非互易磁子Hanle效应
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 实验设计严谨，揭示了反铁磁磁子输运的新物理机制

## Condensed Matter Physics

### 1. **[HiPoly: a hierarchical polymer-native AI framework for property prediction and generative design](https://arxiv.org/abs/2609.02746v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-02
- **作者**: Ge Sun, Gervasio Zaldivar, Yuan Tian et al.
- **标签**: `physics.chem-ph` `cond-mat.mtrl-sci` `cs.AI`
- **AI摘要**: 提出HiPoly框架实现聚合物属性预测与生成设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 创新性引入分层图架构，有效解决聚合物多尺度建模难题

### 2. **[Colossal reversible conductivity switching by room-temperature oxygen-vacancy ordering in Aurivillius oxide films](https://arxiv.org/abs/2609.02629v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-02
- **作者**: Song Zhou, Songge Zhang, Lanting Shi et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 通过氧空位有序化实现Aurivillius氧化物电导率可逆调控
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 利用等离子体诱导缺陷有序化，在材料科学领域具有重大创新性。

### 3. **[Repairing PBE-Spurious Metallicity for HSE06-Level Screening of 2D Photocatalysts for Green Hydrogen Production](https://arxiv.org/abs/2609.02883v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Ritam Chakraborty, Arpan Das
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 利用机器学习修复二维材料带隙计算误差
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 方法创新且实用，有效提升了光催化剂筛选精度

### 4. **[AlterSeeK-Path: Systematic construction of generalized band-structure paths for displaying altermagnetic spin splitting](https://arxiv.org/abs/2609.02770v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Yujia Teng, Mesfin Eshete, Andrea Urru et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 开发AlterSeeK-Path工具以可视化反铁磁能带分裂
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 该工具解决了反铁磁材料能带分析的痛点，方法严谨且实用性强。

### 5. **[Understanding Graphene-Perovskite Interactions: From Flake Chemistry to Crystallisation and Solar Cell Performance](https://arxiv.org/abs/2609.02744v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-02
- **作者**: Oussama Er-Riyahi, Dorota Biernacka, Yating Guo et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示石墨烯调控钙钛矿结晶机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合DFT与实验，系统阐明了石墨烯对钙钛矿性能的提升机理。
