...
### 1. **[Transition of Photonic Dissipative Dynamics through the Exceptional Point](https://arxiv.org/abs/2609.10061v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-09
- **作者**: Yue Cui, Ruihen Jin, Xiong Jiang et al.
- **标签**: `physics.optics`
- **AI摘要**: 揭示非厄米系统中奇异点对光子耗散动力学的重构机制。
<details>
...
- **评分理由**: 实验验证了奇异点附近的耗散动力学转变，具有较高的物理创新性与严谨性。

### 2. **[Expanding RCWA capabilities with advanced S-matrix algorithms](https://arxiv.org/abs/2609.10076v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-09
- **作者**: Philippe Lalanne, Jean-Paul Hugonin
- **标签**: `physics.optics` `physics.comp-ph`
- **AI摘要**: 提出改进的S矩阵算法以优化光子结构模态分析
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 算法重构提升了计算模块化与效率，在光子学领域具有实用价值

### 3. **[Non-Hermitian Light Beams](https://arxiv.org/abs/2609.10011v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-09
- **作者**: Andrey Novitsky, Dongliang Gao, Iryna Kaputskaya et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出非厄米光束概念，拓展非厄米物理自由度。
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，逻辑严密，为光场调控提供新视角。

### 4. **[Optical design for implementing non-collinear circularly polarized high harmonic generation in an enhancement cavity](https://arxiv.org/abs/2609.10235v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-09-09
- **作者**: Pranshu Dave, Thierry Auguste, Olivier Girard et al.
- **标签**: `physics.optics`
- **AI摘要**: 提出一种用于非共线圆偏振高次谐波产生的光腔设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 设计新颖且实验验证充分，对精密光谱学有应用价值

## Metamaterials

### 1. **[Surrogate-Assisted Inverse Design and Temperature-Dependent Electrothermal Analysis of an All-Oxide Narrowband Thermophotovoltaic Emitter](https://arxiv.org/abs/2609.10252v1)**
- **评分**: ⭐ 76/100 | **日期**: 2026-09-09
- **作者**: Bibekananda Nath, Kawshik Nath, Ahmed Zubair
- **标签**: `physics.optics` `physics.app-ph` `physics.comp-ph`
- **AI摘要**: 基于代理模型的全氧化物窄带热光伏发射器逆向设计
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 结合机器学习与FDTD方法优化热光伏发射器，方法严谨且具有实用价值。

## Condensed Matter Physics

### 1. **[Fast, Accurate, and Scalable Fermionic Neural Networks via Translation Equivariance](https://arxiv.org/abs/2609.10186v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-09
- **作者**: David D. Dai, Yen-Ting Lin, Marin Soljačić
- **标签**: `cond-mat.str-el` `cond-mat.dis-nn` `cond-mat.mtrl-sci`
- **AI摘要**: 提出TorFormer实现平移等变费米子神经网络
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过对称性约束显著提升了量子态计算的效率与精度

### 2. **[Observation of Magnetic-Anisotropy Crossover and High-Temperature Skyrmions in the Dirac Magnet Fe3Ge with a Distorted Kagome Lattice](https://arxiv.org/abs/2609.10081v1)**
- **评分**: ⭐ 88/100 | **日期**: 2026-09-09
- **作者**: Yalei Huang, Xiaowei Lv, Bin Li et al.
- **标签**: `cond-mat.mtrl-sci` `cond-mat.str-el`
- **AI摘要**: 发现Fe3Ge中高温拓扑磁斯格明子
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 在高温下观测到斯格明子，实验严谨且具有极高应用潜力。

### 3. **[Overcoming Transport Layer Bottlenecks to Quantify Ionic Parameters from Transient Ion Current Measurements of Perovskite Solar Cells](https://arxiv.org/abs/2609.10438v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-09
- **作者**: Shudi Jiao, Miguel Torre Cachafeiro, Huagui Lai et al.
- **标签**: `cond-mat.mtrl-sci`
- **AI摘要**: 揭示传输层电容限制钙钛矿离子测量
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过实验与模拟揭示了TIC测量的瓶颈，方法严谨且具有重要实用价值。

### 4. **[WannierNLQG: A Julia package for nonlinear optical responses and quantum geometry from Wannier tight-binding models](https://arxiv.org/abs/2609.10411v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-09
- **作者**: Zhuocheng Lu, Zhichao Guo, Yuanyuan Xua et al.
- **标签**: `cond-mat.mes-hall` `cond-mat.mtrl-sci`
- **AI摘要**: 发布非线性光学响应计算Julia工具包
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 工具功能全面且架构严谨，对凝聚态物理研究有重要实用价值。

### 5. **[pyeCE: A Python Implementation of the Embedded Cluster Expansion](https://arxiv.org/abs/2609.10190v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-09
- **作者**: Yann L. Müller, Claire A. Paetsch, Anirudh Raju Natarajan
- **标签**: `cond-mat.mtrl-sci` `cond-mat.stat-mech`
- **AI摘要**: 开发了用于高熵合金热力学预测的pyeCE开源库
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 通过嵌入式簇展开有效解决了多组分合金计算难题，工具链完整且实用性强。

## Theoretical Physics

### 1. **[Multiparameter quantum bounds for entanglement-assisted aperture synthesis](https://arxiv.org/abs/2609.10111v1)**
- **评分**: ⭐ 82/100 | **日期**: 2026-09-09
- **作者**: Kalaga Madhav, Pieter Kok, Nic Scott
- **标签**: `quant-ph` `astro-ph.IM` `physics.optics`
- **AI摘要**: 提出纠缠辅助孔径合成的多参数估计框架
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论创新性强，数学严谨，对量子成像设计有指导意义。

### 2. **[Phase transitions in first-detection statistics of monitored long-range quantum walks](https://arxiv.org/abs/2609.10510v1)**
- **评分**: ⭐ 78/100 | **日期**: 2026-09-09
- **作者**: Sayan Roy, Shamik Gupta, Giovanna Morigi et al.
- **标签**: `quant-ph` `cond-mat.other` `cond-mat.stat-mech`
- **AI摘要**: 揭示长程量子行走首达统计的相变机制
<details>
<summary>原始摘要</summary>
...
- **评分理由**: 理论严谨且创新，揭示了非幺正动力学中的临界行为。

### 3. **[An Explainable Machine Learning Framework for Predicting Blood-Brain Barrier Permeability Using Molecular Descriptors](https://arxiv.org/abs/2609.10012v1)**
- **评分**: ⭐ 75/100 | **日期**: 2026-09-09
- **作者**: Fatemeh Mahmoudi
- **标签**: `cs.LG` `cond-mat.mtrl-sci`
- **AI摘要**: 基于可解释机器学习预测血脑屏障通透性
<details>
<summary>原始摘要</summary>
